...
**Current audit continuation, September 12:** read [RESUME-HERE.md](RESUME-HERE.md) and the [twentieth release record](reports/2026-09-12/twentieth-continuation-release.md). The current ledger records **659 full current MDX reads and 632 scoped updates** across 1,186 files. Heaney/Masterson and eleven instrument-database rows are corrected and verified live at `9e460392`; exact-commit CI, Vercel and five production checks passed. Continue the remaining full-source work and unread pages. The whole-site review remains active after each publication; source, figure and supplement gaps remain explicit. Do not manufacture clinical sign-off.
