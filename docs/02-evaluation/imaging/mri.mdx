...
**Key Point.** MRI complements — rather than replaces — fluoroscopic urethrography and urodynamics. The goal is integrating structural, functional, and tissue-level information to plan the correct operation.
...
**Pitfall.** Gap length on MRI consistently exceeds RUG/VCUG measurement by 3–8 mm because MRI measures tissue gap while fluoroscopy measures the contrast column gap. Use MRI measurements for approach planning — not fluoroscopy measurements alone.
...
**Clinical Pearl.** The decision to perform inferior pubectomy is best made pre-operatively using MRI, not intraoperatively. Patients with gap &gt;2 cm and high prostatic displacement benefit from pre-operative surgical planning that includes pubectomy.
...
**Protocol Note.** Dynamic acquisitions during defecation require rapid single-shot T2 or HASTE sequences with frame rates of 1–2 images/sec. Gradient echo sequences can be used but have inferior tissue contrast. Ensure the image FOV captures the entire pubococcygeal line and the perineal body.
...
**Ureteral Safety.** On T2 coronal imaging, identify both ureteral orifices relative to the fistula margin. Fistulae within 10 mm of a ureteral orifice mandate pre-operative ureteral stent placement regardless of surgical approach. Report ureteral proximity in the MRI interpretation.
...
**Threshold for Decision-Making.** A VI-RADS score of 3 or higher should prompt re-evaluation for primary muscle-invasive disease before TURBT. VI-RADS 4–5 strongly favors radical cystectomy planning over repeat TURBT alone.
...
The **ACR Appropriateness Criteria** for pelvic-floor dysfunction designate **MRI pelvis with gadolinium** as the **preferred examination for the majority of subacute or chronic complications** after pelvic-floor mesh / sling surgery — particularly for the components that ultrasound cannot reach.

### Indications where MRI is preferred over pelvic-floor ultrasound

- **Retropubic sling components** — better than ultrasound, which cannot visualize the retropubic space.
- **Obturator and ischiorectal sling components** — extrapelvic mesh traversing the obturator foramen or ischiorectal fossa.
- **Sacrocolpopexy mesh integrity** — apical / cranial mesh not adequately visualized on ultrasound.
- **Mesh infection, abscess, discitis, osteomyelitis** — soft-tissue contrast and contrast-enhanced sequences identify deep infection.
- **Presacral hematoma** after sacrocolpopexy.
- **Peripheral nerve assessment** — MR neurography for suspected pudendal / obturator / sacral plexus injury.
- **Global pelvic-floor anatomy** for surgical-planning before mesh removal.

### Where ultrasound is preferred over MRI

- Sub- and periurethral midurethral slings and vaginal-wall mesh — synthetic polypropylene is highly echogenic on ultrasound and is often difficult to distinguish from scar on MRI.
- Real-time dynamic assessment during Valsalva.
- Office-based and intraoperative assessment.

### Imaging-protocol considerations

- High-resolution **T2 FSE in 3 planes** for anatomic mesh localization.
- **T1 + fat-saturation post-gadolinium** for inflammation, infection, and abscess.
- **DWI** for abscess detection.
- **MR neurography sequences** when peripheral-nerve involvement is clinically suspected.

For the canonical mesh-complications evaluation and management framework — IUGA / ICS classification, ACOG Committee Opinion 694 management, complete-vs-partial removal evidence, surgical-approach algorithm — see **[Mesh Complications & Removal](/docs/surgical-techniques/04g-prolapse-repair/mesh-complications)**. For the complementary pelvic-floor-ultrasound evaluation see [Ultrasound — Pelvic Floor](/docs/evaluation/imaging/ultrasound).
...
**Antispasmodic Use.** Hyoscine butylbromide (Buscopan, 20 mg IV) is effective and inexpensive. It is contraindicated in glaucoma and tachyarrhythmia. In these patients, glucagon 1 mg IV is an acceptable alternative. Antispasmodics are not needed for PFUI or Peyronie's protocols.
