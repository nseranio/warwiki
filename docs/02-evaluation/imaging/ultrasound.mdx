...
Translabial / transperineal / transvaginal ultrasound is the **preferred first-line imaging modality** for sub- and periurethral midurethral slings and vaginal-wall mesh — synthetic polypropylene is highly echogenic and is often difficult to distinguish from scar on MRI. The **ACR Appropriateness Criteria** recommend ultrasound for the periurethral / vaginal compartment and MRI for retropubic, obturator, and sacrocolpopexy components.

**Key diagnostic-performance signals.**

- **Frigerio 2023** — combined translabial + transvaginal pelvic-floor ultrasound in 100 women with LUTS after mesh / sling surgery showed **100% sensitivity, 98–100% specificity, 100% NPV** for lower-urinary-tract mesh exposure — an excellent screening test to rule out bladder / urethral mesh exposure.
- **Viragh 2018 *Radiology*** — translabial ultrasound for sling erosion (n = 124) achieved **93% sensitivity / 72% specificity** when intramural mesh was included, **outperforming cystourethroscopy** alone (sensitivity 67%) for early or intramural erosion.
- **3D endovaginal ultrasound** provides tomographic reconstructions confirming presence / absence of vaginal-wall mesh, identifying residual mesh after excision, and assessing relationship to the urethral lumen — crucial for surgical planning.
- TVUS detects implanted mesh that physical examination misses in **~ 28% of cases.**

**Key limitations.** Cannot visualize **retropubic** sling components or **extrapelvic** mesh traversing the obturator foramen or ischiorectal fossa; cranial / apical sacrocolpopexy mesh is poorly seen — these require MRI.

For the canonical mesh-complications evaluation and management framework see **[Mesh Complications & Removal](/docs/surgical-techniques/04g-prolapse-repair/mesh-complications)**.
