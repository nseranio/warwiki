...
![Urethral silhouette on a retrograde urethrogram showing the segments and a bulbar stricture](/img/diagrams/rug-urethra.svg)
*The urethral silhouette on a retrograde urethrogram. Contrast fills the lumen from the meatus through the fossa navicularis, penile, bulbar, membranous, and prostatic urethra to the bladder — the **membranous** segment is a normal narrowing at the external sphincter. A **stricture** appears as a focal narrowing (here in the bulbar urethra); because the surrounding **spongiofibrosis** is not opacified, the true stricture extends roughly 1 cm beyond each visible shoulder — the reason RUG systematically underestimates length. The right posterior oblique 45° projection separates the penile from the bulbar urethra so bulbar disease is not hidden by overlap. (Original WARWIKI schematic)*
...
- Absence of bladder neck funneling, or a shelf-like deformity at the bladder neck, suggests **[bladder neck contracture](/docs/clinical-conditions/03b-voiding-outlet/bladder-neck-stenosis)** after benign outlet surgery or radiation.
...
- After radical prostatectomy, the analogous narrowing is **[vesicourethral anastomotic stenosis](/docs/clinical-conditions/03b-voiding-outlet/vesicourethral-anastomotic-stenosis)** at the bladder-to-urethra anastomosis.
