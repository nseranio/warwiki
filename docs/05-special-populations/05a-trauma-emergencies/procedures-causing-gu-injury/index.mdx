...
<ul className="section-stack">
  <li>
    <a href="/docs/special-populations/05a-trauma-emergencies/procedures-causing-gu-injury/cesarean-section" className="section-stack-title section-stack-link">Cesarean Section</a>
