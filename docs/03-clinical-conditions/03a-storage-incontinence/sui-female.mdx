...
See: [Urethral Bulking Agents](/docs/surgical-techniques/04f-incontinence-procedures/urethral-bulking-agents)

#### Artificial Urinary Sphincter

Reserved for severe, complicated SUI — particularly ISD after prior failed surgery or radiation. High-quality data limited for this indication in women; see [AUS article](/docs/surgical-techniques/04f-incontinence-procedures/artificial-urinary-sphincter).[6]
