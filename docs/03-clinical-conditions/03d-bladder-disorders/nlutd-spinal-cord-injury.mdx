...
- **Antimuscarinics** first-line for DO; combination with β3 agonist when monotherapy inadequate. See [Neurogenic Bladder](/docs/clinical-conditions/03d-bladder-disorders/neurogenic-bladder) for agent table.
...
- **Autonomic dysreflexia** — every cystoscopy, urodynamics, and OR case in T6-and-above SCI requires AD prevention: topical lidocaine, BP monitoring, short-acting antihypertensives (nifedipine, nitrate) available. See [Autonomic Dysreflexia](/docs/clinical-conditions/03d-bladder-disorders/autonomic-dysreflexia).
