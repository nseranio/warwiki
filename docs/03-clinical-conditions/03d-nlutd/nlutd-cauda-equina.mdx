...
See [Neurogenic Lower Urinary Tract Dysfunction](/docs/clinical-conditions/03d-nlutd/neurogenic-bladder) for the general framework. Because the post-decompression phenotype is outlet-incompetence-dominant, the key reconstructive procedures are the [Artificial Urinary Sphincter](/docs/surgical-techniques/04f-incontinence-procedures/procedures/artificial-urinary-sphincter), [Male Urethral Slings](/docs/surgical-techniques/04f-incontinence-procedures/procedures/male-urethral-slings), and [Urethral Bulking Agents](/docs/surgical-techniques/04f-incontinence-procedures/procedures/urethral-bulking-agents), with [Catheterizable Channels](/docs/surgical-techniques/04b-bladder-reconstruction/catheterizable-channels) and the [Ileal Conduit](/docs/surgical-techniques/04c-urinary-diversion/ileal-conduit) as late salvage.
