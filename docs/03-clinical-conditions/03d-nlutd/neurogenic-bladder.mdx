...
| **Suprasacral spinal (above the sacral micturition circuitry)** | SCI above conus, MS with spinal plaques, transverse myelitis | **DO + detrusor–sphincter dyssynergia (DSD)** | **High — upper-tract risk** | **Disrupted** |
