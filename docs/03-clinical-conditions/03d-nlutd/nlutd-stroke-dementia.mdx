...
- Storage pressures are often low, but risk classification still depends on emptying, complications and any coexisting disease.
...
- **Antimuscarinics** — use cautiously; lower-CNS-penetrating agents may be considered, but no antimuscarinic is established as cognitively risk-free. **Avoid oxybutynin IR** in dementia. Add to the patient's **anticholinergic burden score** — multiple anticholinergic drugs (including urologic + antihistamine + TCA + bladder + bowel) compound cognitive decline.
