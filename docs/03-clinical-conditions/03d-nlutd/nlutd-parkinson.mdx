...
- **~25–40%** of PD patients have clinically relevant urinary symptoms.<sup>[[2]](#ref2)</sup>
...
- **β3-adrenergic agonists (mirabegron, vibegron)** — often attractive when avoiding anticholinergic burden. AUA permits either class or combination; it does not require a beta-3-first sequence for all PD patients. Disease-specific evidence is stronger for mirabegron than for assuming a class-wide effect.<sup>[[3]](#ref3)</sup><sup>[[1]](#ref1)</sup>
