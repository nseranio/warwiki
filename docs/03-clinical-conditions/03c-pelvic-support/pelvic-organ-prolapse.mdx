...
*The six POP-Q points on a midsagittal view of the vaginal canal, all measured in centimeters relative to the hymen (the zero reference plane). **Aa** and **Ap** are fixed points 3 cm above the hymen on the anterior and posterior walls; **Ba** and **Bp** are the most dependent points of the upper walls; **C** is the cervix or vaginal cuff and **D** the posterior fornix (omitted after hysterectomy). **gh**, **pb**, and **tvl** are the genital hiatus, perineal body, and total vaginal length. As prolapse advances the leading edge descends past the hymen from negative toward positive values — the basis of the stage bands at right. (Original WARWIKI schematic)*
