...
The Cocci systematic review summarizes contemporary complication evidence.<sup>[[2]](#ref2)</sup> PHOENIX estimates require the correction described below.

:::warning[PHOENIX data correction — July 23, 2026]

The registry investigators removed 38 incorrectly registered patients, changing the cohort from 1,072 to 1,034 and revising numerical results. The original early-event percentages previously reproduced here have been withdrawn pending verification of the corrected tables; they should not be used as current consent estimates. The accessible correction notice establishes the cohort change, but does not provide all corrected endpoint details.<sup>[[1]](#ref1)[[6]](#ref6)</sup>
...
Early overall complications, hematoma, and retention estimates from PHOENIX are withheld as described above. The remaining ranges below come from heterogeneous literature and are not an individual risk calculator.
...
- **Immediate recognition.** If detected within hours of surgery, deflation of the device may partially restore glans perfusion; partial or complete device explantation may be required if the ischemia progresses.
...
- **Glans debridement or partial amputation.** Only if necrosis is established and unsalvageable; the patient should be aware of the cosmetic consequences
