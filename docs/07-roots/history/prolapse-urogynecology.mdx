...
**James Marion Sims** is the most influential and most ethically contested figure in the history of operative gynecology. Born in Lancaster, South Carolina in 1813, Sims conducted his experiments between 1845 and 1849 on enslaved African American women with obstetric VVF in Montgomery, Alabama, without informed consent and with minimal or no anesthesia.

His subjects, Anarcha, Betsey and Lucy, endured multiple operations. Anarcha underwent 30 procedures before Sims achieved a consistent repair. The innovations that enabled success:
...
**William Edward Fothergill** (1907–1908) modified Donald's technique by incorporating suturing of the cardinal (Mackenrodt's) ligaments directly to the cervical stump, enhancing uterine suspension. Because Fothergill's publication was more widely read, the original developer's name was largely displaced, and the procedure became known as the **Manchester repair** or **Manchester-Fothergill operation**.

Core components: anterior colporrhaphy, cervical amputation and cardinal ligament plication. Still performed today as a uterine-sparing option with durable long-term results.<sup>[[9]](#ref9)</sup>
...
- **Level I**: Apical suspension via the uterosacral and cardinal ligament complex to the pelvic sidewall and sacrum
...
**Eric Glen** (1971) founded the ICS (originally the "Continent Club") in Exeter, UK, with an inaugural meeting of 60 participants. The ICS grew to approximately 3,000 members from more than 80 countries and established the standardized terminology and classification systems foundational to all urogynecological research.<sup>[[25]](#ref25)</sup>
...
These products promised tension-free prolapse repair without autologous tissue harvest and with reduced operating time. However, post-marketing surveillance revealed high rates of mesh erosion or exposure (10–20%), dyspareunia, chronic pelvic pain, and mesh contraction, complications that proved difficult to treat and in some cases irreversible.
...
**Regulatory Precedent.** The transvaginal mesh crisis fundamentally changed how medical devices are evaluated. The 510(k) clearance pathway, which allowed mesh kits to market without clinical trials based on "substantial equivalence" to a 1955 tantalum mesh paper, was exposed as wholly inadequate for implanted mesh devices. The FDA subsequently strengthened premarket approval requirements for high-risk implants.
