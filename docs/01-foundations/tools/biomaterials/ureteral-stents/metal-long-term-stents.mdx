...
See also: [Double-J Stent](/docs/foundations/tools/biomaterials/ureteral-stents/double-j-stent), [Ureterocolonic Fistula](/docs/clinical-conditions/03f-fistulas/all-patients/ureterocolonic), [Vascular-Urinary Fistula](/docs/clinical-conditions/03f-fistulas/all-patients/vascular-urinary) — long-indwelling stents in a radiated pelvis are a key risk factor for vascular-urinary fistulas.
