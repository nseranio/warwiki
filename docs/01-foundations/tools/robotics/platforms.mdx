...
See also: [Reconstructive Applications](/docs/foundations/tools/robotics/reconstructive-applications), [Single-Port Robotics](/docs/foundations/tools/robotics/single-port).
...
- **da Vinci SP (2018, FDA; 2024, CE)** — single-port system; 2.5 cm cannula houses a flexible 3D endoscope + three multi-jointed wristed instruments. See [Single-Port Robotics](/docs/foundations/tools/robotics/single-port).<sup>[[5]](#ref5)[[6]](#ref6)</sup>
