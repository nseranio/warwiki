...
5. Secure with staples or sutures; quilt to the bed (see [Quilting Stitch](/docs/foundations/surgical-skills/special-techniques/quilting-stitch)) to prevent shear

See also: [Zimmer Air Dermatome](/docs/foundations/tools/instruments/graft-harvest/zimmer-air-dermatome), [Padgett Dermatome](/docs/foundations/tools/instruments/graft-harvest/padgett-dermatome), [STSG](/docs/foundations/surgical-principles/grafts/stsg), [Quilting Stitch](/docs/foundations/surgical-skills/special-techniques/quilting-stitch), [Fournier's Gangrene](/docs/special-populations/05a-trauma-emergencies/fourniers-gangrene).
