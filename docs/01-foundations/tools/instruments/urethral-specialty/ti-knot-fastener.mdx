...
**Retained TK fasteners** can calcify over time, creating an intraluminal **calculus** that may require endoscopic removal. This is analogous to the historical issue of retained **hem-o-lok clips** migrating into the bladder after robotic prostatectomy. Counseling and surveillance for encrustation are part of [TUITMR](/docs/surgical-techniques/04ab-bladder-neck-reconstruction/bnc-vuas/transurethral-incision-transverse-mucosal-realignment) follow-up.<sup>[[1]](#ref1)</sup>
