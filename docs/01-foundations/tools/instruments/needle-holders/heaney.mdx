...
![Schematic line drawing of the Heaney needle driver showing the double curvature: angled shaft sweeping up from the finger rings and angled jaws curving back down to deliver the needle perpendicular to deep pelvic tissue](/img/instruments/heaney-needle-driver.svg)
*Heaney needle driver schematic — the **double curvature** (shaft sweep + jaw curve) keeps the surgeon's hand outside the pelvic cone while still presenting the needle perpendicular to the tissue plane.*
