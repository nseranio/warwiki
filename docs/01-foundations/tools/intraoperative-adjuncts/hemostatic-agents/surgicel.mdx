...
| **[Gelfoam](/docs/foundations/tools/intraoperative-adjuncts/hemostatic-agents/gelfoam)** | Passive matrix, neutral pH | Bone bleeding; can combine with thrombin |
| **[Arista AH](/docs/foundations/tools/intraoperative-adjuncts/hemostatic-agents/arista)** | Passive, absorbs water → concentrates clotting factors | Diffuse oozing; no persistent foreign body after 48 hours |
| **[FloSeal](/docs/foundations/tools/intraoperative-adjuncts/hemostatic-agents/floseal)** | Active — contains thrombin | Coagulopathic patient; high-volume oozing |
| **[Topical thrombin](/docs/foundations/tools/intraoperative-adjuncts/hemostatic-agents/topical-thrombin)** | Active — pure thrombin | Combined with Gelfoam for targeted activity |
...
- [Gelfoam / Surgiflo](/docs/foundations/tools/intraoperative-adjuncts/hemostatic-agents/gelfoam)
