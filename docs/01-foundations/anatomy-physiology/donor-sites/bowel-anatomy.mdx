...
- **Relevance to urinary reconstruction**: bowel used as a conduit / reservoir continues to produce mucus and is often bacteriuric. Do not screen for or treat **asymptomatic** bacteriuria in reconstructed lower urinary tracts as a routine measure; assess compatible symptoms and treat symptomatic infection, and screen/treat before urologic procedures that breach the mucosa. Stones or stoma problems require their own assessment rather than automatically making a positive urine culture an antibiotic indication.
...
- **Ileal conduit (Bricker).** A short ileal segment is isolated proximal to the ileocecal valve, with ileoileal re-anastomosis, Wallace or Bricker ureteroileal anastomosis, and an end stoma. Segment length and distance from the valve are individualized to reach, blood supply and remaining bowel; **preserving a specified 15–20 cm does not guarantee normal B12 absorption**. Monitor B12 after cystectomy with bowel diversion rather than prescribing lifelong replacement solely from a length cutoff.
...
- **Indiana pouch (ileocecal continent cutaneous).** Right colon and an ileal segment are reconfigured; tapering/plication helps create the catheterizable continence mechanism. Segment dimensions and the stoma site (umbilical or another suitable marked location) are individualized. Counsel about B12 surveillance.
