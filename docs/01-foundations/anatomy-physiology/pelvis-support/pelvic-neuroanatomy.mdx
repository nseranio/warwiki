...
**Saving only the NVB is not enough.** Preserving only the lateral neurovascular bundle during radical prostatectomy / cystectomy does not preserve the dorsal contribution. Both routes must be respected; early seminal-vesicle tip sparing in the cystectomy extirpation, when oncologically safe, preserves dorsal fibers.
...
*The course of the pudendal nerve (S2–S4). After converging from the sacral roots it exits the pelvis through the **greater sciatic foramen** below piriformis, hooks around the **ischial spine** and sacrospinous ligament, re-enters through the **lesser sciatic foramen**, and runs forward in **Alcock's (pudendal) canal** on the obturator internus before dividing into the **inferior rectal**, **perineal**, and **dorsal** nerves. Two zones carry surgical risk: the ischial spine — the sacrospinous-fixation suture passes just medial to the nerve, and it is the landmark for a pudendal block — and Alcock's canal, the site of entrapment and pudendal neuralgia. (Original WARWIKI schematic)*
