...
Acellular matrices, decellularized small-intestinal submucosa (SIS), and cell-seeded scaffold constructs developed to replace autologous donor-site harvest. See the dedicated deep dive: [Tissue-Engineered Grafts & Bioscaffolds](/docs/foundations/surgical-principles/grafts/tissue-engineered) — current evidence in urethroplasty, bladder, and vaginal reconstruction; FDA / regulatory status; failure modes; why autologous BMG remains the urethroplasty standard.
