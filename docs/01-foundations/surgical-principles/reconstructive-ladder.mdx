...
:::note
See also [Negative Pressure Wound Therapy](/docs/foundations/biomaterials) in the Biomaterials section for device selection and specific wound VAC protocols.
:::
...
:::note Core Principle
The goal is not to start at the bottom — the goal is to **match the reconstruction to the defect** using the simplest reliable solution. Overtreatment carries its own morbidity.
:::
