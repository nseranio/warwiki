...
- [Methylene blue](/docs/foundations/pharmacology/intraoperative-adjuncts/visualization-agents/methylene-blue) — replacement for visible-light applications
- [Pudexacianinium (ASP-5354)](/docs/foundations/pharmacology/intraoperative-adjuncts/visualization-agents/pudexacianinium) — NIR replacement for IV ureteral identification
