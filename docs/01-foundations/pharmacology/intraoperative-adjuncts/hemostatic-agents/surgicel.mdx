...
Do not combine Surgicel with topical thrombin: its acidic environment inactivates thrombin. Use only the minimum needed; product forms have different handling and removal instructions.<sup>[[2]](#ref2)</sup>
...
- **Remove after hemostasis in bony confines or near structures threatened by swelling**; the IFU specifies mandatory removal near the spinal cord, optic nerve/chiasm and susceptible tubular structures.<sup>[[2]](#ref2)</sup>
