...
- `auth_handoff`: next six urinary-catheter pages have complete original reads and research underway. High-yield 2026 COMPARE/MultICath reusable-catheter evidence requires full-paper review. Correct insertion, balloon, CBI, prophylaxis and surveillance guidance. The seventh batch is now being edited.
