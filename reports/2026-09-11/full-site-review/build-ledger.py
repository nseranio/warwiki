...
records={}
for name in ['clinical-conditions.json','urethral-upper-tract.json','pharmacology.json','root-reviewed-pages.json','surgical-rest.json','surgical-bladder.json','surgical-diversion.json','special-populations.json','evaluation.json','foundations-rest.json','resources-history.json','site-data.json']:
 p=HERE/name
