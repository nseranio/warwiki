...
records={}
for name in ['clinical-conditions.json','urethral-upper-tract.json','pharmacology.json','root-reviewed-pages.json','surgical-rest.json','surgical-bladder.json','surgical-diversion.json','surgical-genital.json','special-populations.json','evaluation.json','foundations-rest.json','resources-history.json','site-data.json','tools.json','surgical-fistula.json','surgical-incontinence.json','perioperative-care.json']:
 p=HERE/name
