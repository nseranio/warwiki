...
## AUGS full text needed

Status on September 25, 2026: the 26 AUGS documents from the September 24 email were supplied as PDFs and are now integrated (local text in `reports/audit-v2/sources-local/augs-2026-09/`, gitignored). No AUGS document is still waiting for full text. Items below remain not checkable and name the source that would settle them.

- **Vaginal estrogen product labels** (`vaginal-topical-estrogen.mdx`): boxed-warning status and label dates for Vagifem (2/2024), Imvexxy (11/2023), Premarin cream (5/2025) and Estring (4/2026) came from WebFetch summaries of DailyMed and the Pfizer label. Re-verify against the current DailyMed labels. The FDA February 12, 2026 announcement does not list the affected products. FDA action on the AUGS December 2025 advisory (removal of the boxed warning) is not final.
- **`vaginal-laser-therapy.mdx`, `gsm.mdx`:** ACOG Committee Opinion 795 author string; FDA 2018 "not cleared for GSM/SUI" wording (secondary reports only); per-trial laser figures (Avul, Lin, Bayraktar, Siliquini, Li 2023) at abstract level; ACOG PB 213 term-origin claim; ref 6 (AFP) has no DOI.
- **`microfat-nanofat-grafting.mdx`:** Casarotti 36-month relapse figure and Hickey 2024 wording checked at abstract level only.
- **`recurrent-uti.mdx`, `geriatric-urology.mdx`, `urine-studies.mdx`:** IDSA 2019 statements are attributed through the AUGS summaries; IDSA text not read. `geriatric-urology.mdx` is `partial` (many other claims unverified). Fok 2013 denominators (matched analysis) and CO 703 page numbers should be confirmed from the papers.
- **Prolapse pages:** NICE, ASPIRe, CARE and technique-video references were not re-read; SAM population wording (point D threshold) unverified; Carberry 2025 has no PubMed record (checked against the PDF only). `vaginal-hysterectomy.mdx` is `partial`: the 2021 meta-analysis figures (mean 68.5 days, 64% intercourse-triggered) are attributed to the AUGS text and not re-read in the meta itself. The AUGS cervical-elongation threshold is inconsistent inside the statement (above 4 cm in the table, 4 cm or more in the text, above 2 cm in a cited series); the page states the table value and the series with attribution.
- **`cancer-survivorship/index.mdx`, `uterine-manipulator.mdx`, `pederson.mdx`, `assessment-tools.mdx`:** `partial`; only the AUGS items were added. ICSI/ICPI and PUF score ranges, the GRA scale points and an ICIQ-OAB module-specific validation paper were left out because they could not be verified.
- **`billing-coding.mdx`:** wRVUs are verified against RVU26C (July 2026 release). CPT long descriptors are paraphrased (AMA copyright). Codes 58293, 54438 and 52647 are absent from the CY2026 file and should be reviewed for deletion. The NCCI note for 64566 imaging (Medtronic guide) is not included because it was not verified. LCD L35170 jurisdictions and states were not verified; the page says other contractors may differ.
...
- status: checked (2026-09-24)
- open: STILL NOT CHECKABLE: Ialuril manufacturer IFU; intravesical oxybutynin 5-10 mg/20-30 mL 30 min; Corona 2026 meta figures, Moss 2023, CUA 2025 details, Li 2025 DMSO wording.

## 01-foundations/pharmacology/bladder-pain-ic-bps/oral-ic-bps-agents.mdx
- status: checked (2026-09-24)
- open: STILL NOT CHECKABLE: AUA 2022 full-text cyclosporine/Hunner wording beyond prior checks; amitriptyline 10 mg x1wk titration pearl; Buford 2026 consensus not reviewed.
...
- status: checked (2026-09-24)
- open: Still not checkable: ECMM/ISHAM/ASM 2025, Jenkin 1998, Miller 2024, IDSA aspergillosis 2016 renal statements, Bausch 2026. lint pass.
...
- status: checked (2026-09-24)
- open: Still not checkable: Porru 2014; Volonte/Munir/Steinman/Schmiemann/Lorenzo-Gomez beyond abstract; NICE NG112; OM-89 6 mg strength (label). lint pass.

## 01-foundations/pharmacology/infection-prophylaxis/perioperative-antibiotic-prophylaxis.mdx
- status: checked (2026-09-24)
- open: Still not checkable: FDA aortic/dysglycemia dates, 2022 allergy parameter cefazolin statement, Seidelman 28-RCT OR 1.06, Brant/Sun figures, Calderwood 2022.

## 01-foundations/pharmacology/infection-prophylaxis/prosthetic-infection-biofilm.mdx
- status: checked (2026-09-24)
- open: Still not checkable: Irrisept/Coloplast labels, Simhal dip-removal detail, Im 2026/Abou Chawareb survey %, Helo 2025 beyond abstract, ACOG ref 31, IDSA ASB via summary.

## 01-foundations/pharmacology/infection-prophylaxis/uti-suppressive-prophylactic.mdx
- status: checked (2026-09-24)
- open: Still not checkable: refs 19, 14, 15, 20, IDSA 2019 transplant ASB timing, HIPREX label, frmRAB ref 11, TMP hyperkalemia attribution ref 3. lint pass.

## 01-foundations/pharmacology/infection-prophylaxis/uti-treatment-antibiotics.mdx
- status: checked (2026-09-24)
- open: Still not checkable: cipro/aminoglycoside renal rules beyond EAU, IDSA 2025 antibiogram/CAUTI via web summary, refs 2,3,13,33,34 (no DOI). lint pass.

## 01-foundations/pharmacology/intraoperative-adjuncts/hemostatic-agents/arista.mdx
- status: checked (2026-09-24)
- open: Not checkable: page does not mention granuloma (comparison row stays 'not established'), full IFU PDF, cost/FloSeal comparisons (no source; softened), ref2/ref3 not re-read.

## 01-foundations/pharmacology/intraoperative-adjuncts/hemostatic-agents/floseal.mdx
- status: checked (2026-09-24)
- open: Not checkable: 2-5 mL typical volume (stated as surgeon judgment), gas-embolism wording (labels give intravascular uptake/negative venous pressure and no-air-to-clear-tip only; human IFU lacks negative-pressure line), 10 mL human-thrombin IFU not supplied, refs 1/3 web pages.

## 01-foundations/pharmacology/intraoperative-adjuncts/hemostatic-agents/gelfoam.mdx
- status: checked (2026-09-24)
- open: Not checkable: Gelfoam Powder as current Pfizer product (not in supplied label), ~200% expansion, RARP NVB use (technique), ref1 beyond abstract.

## 01-foundations/pharmacology/intraoperative-adjuncts/hemostatic-agents/index.mdx
- status: checked (2026-09-24)
- open: Not checkable: relative cost tiers, hub silent on nothing further.

## 01-foundations/pharmacology/intraoperative-adjuncts/hemostatic-agents/surgicel.mdx
- status: checked (2026-09-24)
- open: Not checkable: NVB strip (technique, now labelled), Nu-Knit handling specifics beyond cuttable, heparinized efficacy (mechanistic), 7-14 d primary source.
...
- status: checked (2026-09-24)
- open: STILL NOT CHECKABLE: (1) '5-60% SUI at 3-6 months' range (guideline gives only 90% continent at 6 mo after RALP and Fig 1 without numbers); (2) exact '5-20% persistent beyond 1 yr' range (guideline implies about 6%; upper bound needs Castellan/cohort source); (3) preoperative LUTS and surgeon volume as risk factors (not in guideline); (4) neurogenic T11-L2/S2-4 physiology cited to AUA/SUFU NLUTD 2021; (5) sling row outcomes rely on Sandhu 2010/Prebay 2023 full text; (6) Cochrane Silva 2014 bulking (abstract only, though guideline #25 supports low efficacy); (7) mild/moderate pad bands (<100 g, 100-500 g) and 1-2/3-5 pads still unsourced (guideline defines only severe). Currency: BAUS 2025 consensus not reviewed.
...
- status: checked (2026-09-24)
- open: STILL not checkable: 'high bladder-neck tone' risk factor; SIU grade statements (Abbasi review, not primary).
...
- status: checked (2026-09-24)
- open: STILL not checkable: EPAPP operative details (VanDyke 2021 full text); Furr 2019 ED figure; Holm 2026 event counts; Gallegos 2016 ED (review); Shakir 2019 n=14; technique steps 1-7 (operative texts); videos. EAU 'posterior maneuver ~2 cm' statement not found in EAU text and is not on the page.

## 04-surgical-techniques/04a-urethral-reconstruction/male-urethroplasty.mdx
- status: checked (2026-09-24)
- open: STILL not checkable: Jordan vessel-sparing EPA 2007; Morey ventral onlay glanuloplasty 2001; Wee & Joseph Singapore flap 1989; Yii/Niranjan lotus petal 1996; Jordan fossa flap 1987 and <=2.5 cm limit; Blandy PU 1968; Asopa 2001; Orandi 6-8 cm and Quartey 12-15 cm reach; Kulkarni 2009; Sa/Xu 2021 PFUI; PUL VanDyke 2017 date. Child pages not audited.

## 04-surgical-techniques/04a-urethral-reconstruction/minimally-invasive/dviu.mdx
- status: checked (2026-09-24)
- open: STILL not checkable: refs 2,6,9,13,14,16 not opened (Hampson 2014, Gelman 2011, HTA OPEN monograph, Farrell 2017, Rozanski 2021, Bandini 2023). lint pass.
...
- status: checked (2026-09-24)
- open: STILL NOT CHECKABLE: (1) Argus 'largely superseded by ATOMS' and REMEEX 'niche' rows (guideline silent; Argus/REMEEX not covered); (2) MASTER serious-AE counts 6/11 and Virtue rows not re-read; (3) EAU 'ProACT not after radiation' chapter edition unpinned; (4) PUL and BNC+channel salvage rows (guideline #34 supports diversion/BNC+Mitrofanoff/SPT in general but not PUL); (5) ProACT 60% dry (Larson) and ATOMS 68% figures were not re-checked against the guideline's cited 55% cure/80% improvement pooled (ref 171) since definitions differ; (6) AdVance-specific dryness/explant remain without a device-specific source.
...
- status: checked (2026-09-24)
- open: STILL not checkable: female cuff median 7.0 cm/6.5-8 cm (Cotte 2023, Phe 2017 full text), max two prior surgeries, radiation contraindication, vaginal route abandoned, catheter thresholds (Biardeau 2015), Peyronnet 2019 details, >250,000 implants, Frazier atrophy incidence. lint citations+links pass.

## 04-surgical-techniques/04f-incontinence-procedures/procedures/autologous-pubovaginal-sling.mdx
- status: checked (2026-09-24)
- open: STILL not checkable: Asfour 1x8 cm graft, Cochrane six-trial MUS subset, baseline fascia lata stripper specifics/Latini 2004 (not restored).

## 04-surgical-techniques/04f-incontinence-procedures/procedures/female-slings-suspensions.mdx
- status: checked (2026-09-24)
- open: STILL not checkable: AUGS/ACOG/FDA web docs (4-6,13,15,24-26), Wu NEJM 2021, EUGA 2025, Gallo 2024 not abstract-verified; step lists are established teaching.
...
- status: checked (2026-09-24)
- open: STILL NOT CHECKABLE: (1) 'ATOMS effective across all severity strata' (guideline severity data is for ProACT, not ATOMS; softened to selected cases, needs Esquinas/Angulo); (5) MASTER SAE counts 6/13 vs 8/15 wording unverified without Eur Urol full text; (6) InVance 2-12% infection (guideline only says bone-anchor references are historical); (7) Kahokehr, Chua, Papachristos, Habashy, Cornu, Ammirati abstract-only; ProACT erosion p=0.005 stays removed.
...
- status: checked (2026-09-24)
- open: STILL not checkable: TOMUS perforation 15/298 (not in abstract), AUGS checklist (ref 6), EAU web guideline (ref 8), technique steps (teaching, no source).
...
- status: checked (2026-09-24)
- open: STILL not checkable: 596 analysed/4 exclusions, baseline dyspareunia imbalance, EAU link, IFU-level technique steps.
...
- status: checked (2026-09-24)
- open: STILL not checkable: OPTIMAL '3 of 8' suture removal, ASPIRe '358 in primary analysis', Athanasiou 2026 technique claims, AUGS/IUGA 2020 terminology and Fig 5, '2-3 cm medial to ischial spine' landmark.

## 04-surgical-techniques/04g-prolapse-repair/apical/uterosacral-ligament-suspension.mdx
- status: checked (2026-09-24)
- open: Not checkable: (2) Buller 2001 ureter/spine distances and Ramanah rectum-medial - full text not reachable; (3) Lavelle, Campagna, Meriwether 2018, Spelzini, Shah 2022, Teilmann-Jorgensen 2026, Ow 2016, Douligeris, Azadi, AUGS/IUGA 2020 terminology not re-opened; (4) Barba mannitol 11 vs 1 injury counts need full text; (5) E-OPTIMAL 5-yr retreatment 11.9% vs 8.1% not on page.

## 04-surgical-techniques/04g-prolapse-repair/index.mdx
- status: checked (2026-09-24)
- open: STILL not checkable: FDA April 2019 order (fda.gov not fetched); AWMF 2026 iliococcygeus statement (not in PubMed); PEOPLE/SAVE-U row text (subpages); Kelly plication 'supplanted by MUS' (teaching; NICE 1.5.14 does advise against anterior colporrhaphy for SUI) and Burch-with-SCP advice not source-checked; Cochrane 2026 anterior update (CD004014.pub7) not resolved here. Note: NICE colpocleisis rec (1.8.18) also requires increased operative risk; hub wording is not attributed to NICE.
