...
## Current handoff snapshot — May 4, 2026 (female cosmetic per-device labiaplasty buildout: trim + wedge + de-epithelialization + laser-assisted)

First per-device pages for the female-cosmetic atlas — labiaplasty technique tier. Branch: `claude/cool-pascal-906142`; pushes via `git push origin HEAD:main`. **Commit-and-push-after-every-change cadence preserved.**

### Four new dedicated female-cosmetic atlas pages

| Page | Refs | Headline anchors |
|---|---|---|
| [trim-labiaplasty.mdx](docs/04-surgical-techniques/04l-cosmetic-genital-surgery/trim-labiaplasty.mdx) | 12 | **Zahedi 2023 trim-vs-wedge algorithm** (the locked decision tool: trim when patient wants edge / pigment removal, has poor edge quality, diffuse protrusion, or uses nicotine / cocaine); **Minikowski 2025 RCT n=48** (wedge vs trim equivalent on FGSIS / BDD-symptom reduction at 6 mo — central evidence-base anchor for "no clear winner"); Escandón 2022 PRS meta (lower dehiscence than wedge); Géczi 2024 Aesthet Surg J meta; Sorice-Virk 2020 PRS prospective n=62 (6.5 of 11 symptoms preop → 93.5% symptom-free postop); Goodman 2010 multicenter n=258 (91.6% satisfaction); **Sharp 2016 PRS** (preoperative distress predicts lower postoperative satisfaction p=0.001 — preoperative-BDD-screening anchor); Ucar 2025 comparative cohort (trim FGSIS > wedge); Hunter 2016. **Indication pattern**: hyperpigmented edge, irregular edge, diffuse protrusion, smokers / cocaine users. Step-by-step technique table; trim-vs-wedge comparative summary. |
| [wedge-labiaplasty.mdx](docs/04-surgical-techniques/04l-cosmetic-genital-surgery/wedge-labiaplasty.mdx) | 20 | **Alter 1998 origin + Alter 2008 PRS extended hockey-stick** (the canonical landmark — n=407 single-surgeon series; reoperation 2.9%; mean satisfaction 9.2/10; 93% improved self-esteem; 71% improved sex life; 95% improved discomfort; 98% would repeat); **Sinnott 2020 dehiscence-risk-factor multivariable** (single-layer closure p=0.050; concurrent mons liposuction p=0.011; active smoking — the operative risk-mitigation anchor); Nwaoz 2021 (local-vs-general anesthesia equivalence); **Köle 2024 IUJ Turkish multicentric n=2,594** (wedge complication 3.0% vs trim 0.5% — the head-to-head head-to-head population dataset); **Shi 2026 modified-wedge composite n=738** (99.2% aesthetic / 96.2% overall satisfaction; delayed healing 3.3%; perceived asymmetry 1.4%); Xia 2021 PRS three-step composite n=136 (95.5%); Yang 2020 individualized upper-vs-lower-pedicle by morphology; Qiang 2021 modified non-parallel closure; Triana 2024 hoodplasty; Escandón 2022 + Géczi 2024 metas; Minikowski 2025 RCT; **Zulfikaroglu 2025 sexual-function meta** (SMD 0.52, 95% CI 0.38–0.65; no technique clearly superior, low certainty). Six-row variants table; comparative trim-vs-wedge summary; technical-pearls section for dehiscence prevention (multilayer closure mandatory; tension-free; avoid concurrent mons lipo; screen smokers). |
| [de-epithelialization-labiaplasty.mdx](docs/04-surgical-techniques/04l-cosmetic-genital-surgery/de-epithelialization-labiaplasty.mdx) | 9 | **Choi-Kim 2000 PRS founding description**; **Géczi 2024 meta — highest pooled satisfaction 97% (95% CI 85–99%)** of any labiaplasty technique; **Escandón 2022 meta — lowest dehiscence rate** (vs wedge 3% / laser 5%); **Cao 2012 JPRAS central + posterior modification n=167** (one minor dehiscence); **Jiang 2021 Aesthet Plast Surg medial de-epi + lateral edge resection n=~50** (94.1% satisfaction; FSFI > wedge); **Wang 2025 modified mucosal advancement + de-epithelialized flap n=25** (100% satisfaction; no adverse events); Hunter 2016. **Indication pattern**: mild–moderate width-only excess; edge-preservation goal; sensory priority. **Central limitation**: limited reduction capacity — not for severe hypertrophy. Inability to address edge irregularity is inherent (not a complication). |
| [laser-assisted-labiaplasty.mdx](docs/04-surgical-techniques/04l-cosmetic-genital-surgery/laser-assisted-labiaplasty.mdx) | 18 | **Framed explicitly as a surgical tool, not a technique** — CO₂ (10,600 nm; 10–30 W) substitutes for scalpel within any resection pattern. **FDA 2018 distinction admonition**: 2018 Safety Communication targets *non-surgical, non-excisional* energy-based "vaginal rejuvenation" (lasers + RF), **not** laser-as-surgical-cutting-tool — common counseling and marketing confusion that warrants explicit disambiguation table at the top of the page. **Géczi 2024 meta**: laser significantly less intraoperative bleeding, postoperative swelling, and hematoma vs scalpel (p &lt; 0.05 each); less scar contraction. **Escandón 2022 meta**: laser highest pooled dehiscence rate (5%, 95% CI 2–8%) — higher than wedge (3%) and trim. **Mechanism of dehiscence**: lateral thermal-coagulation zone 100–500 µm (Hendrick 1995, Filmar 1989) → delayed early re-epithelialization, lower early tensile strength, normalizes over time but exposes the wound during the period when activity restriction is hardest to enforce. **Pardo 2006** *Int J Gynaecol Obstet* n=55 single-center: 100% satisfaction at 60 days; 7% minor dehiscence (all healed without intervention). Tool-comparison table laser-vs-scalpel-vs-RF/electrocautery; safety-overhead requirements (eye protection, plume evacuation, laser safety officer); McGrattan 2025 long-term complications context; Toplu 2021 surgical-laser combined with non-surgical fractional CO₂ "genital beautification" caveat. |

### Database row repointing

All four labiaplasty rows in [female-cosmetic.mdx](docs/04-surgical-techniques/04l-cosmetic-genital-surgery/female-cosmetic.mdx) repointed from the placeholder `genital-reconstruction-principles` slug to their canonical per-device pages. Each row note compressed to evidence-anchored one-paragraph summary.

### Editorial conventions reaffirmed this session

- **Female-cosmetic per-device-page pattern follows male-cosmetic precedent** — `sidebar_class_name: sidebar-hidden-item` so the page is reachable via the database row but not visible in the sidebar; `slug: /surgical-techniques/04l-cosmetic-genital-surgery/<name>`; `:::warning[Society positioning]` admonition at the top citing **ACOG 2020 Committee Opinion No. 795** + **FIGO 2025** + **ACOG 686 (adolescents)** rather than SMSNA 2024 (which is the male-cosmetic equivalent). Same locked structure: definition / concept → indications → surgical technique table → modifications → outcomes → complications → comparative summary vs sibling techniques → postoperative management → See Also → References.
- **Tool-vs-technique distinction (laser-assisted)**. The laser-assisted page is the first cosmetic-female page that frames a method as a *surgical tool* applied to other techniques rather than as its own resection pattern. This affects the comparison logic — laser is compared to other tools (scalpel, RF, electrocautery), not to other resection patterns.
- **FDA 2018 disambiguation locked as admonition pattern.** Any cosmetic-female page touching energy-based devices must explicitly distinguish *surgical-cutting-tool* use from *non-surgical "rejuvenation"* use. This is the locked structural pattern: top-level disambiguation table with a clear "what the laser does / tissue removal / FDA clearance" three-column comparison.
- **Hierarchy of central anchors per labiaplasty technique** (now established):
  ...
  - Laser-assisted → **FDA 2018 distinction** + **Pardo 2006 series** + **Géczi 2024 tool-comparison meta** + **Escandón 2022 highest-dehiscence finding**
- **Source-cleanup checklist applied** (now standard for every chatbot-augmented page): strip trailing "Would you like to explore..." prompts; reconstruct swallowed `<` artifacts (every `(p[N])` → `p &lt; 0.05`; `~ 2%, 95% CI [7]` → reconstruct from the actual reference); rebuild mashed comparison tables (no whitespace between cells) into proper markdown; convert `[N]` bracket citations to `<sup>[[N]](#refN)</sup>`; add DOI / PubMed links to every reference with `<a id="refN"></a>` anchors; filter bleed-through references; cross-check every cited ref is actually used in body and matches the claim it supports.
- **Database-row notes for cosmetic-female pages still expanded** — distinct from the male-cosmetic database where notes were dropped entirely on May 4. Reason: the female-cosmetic database does **not** yet have a per-device page for every row (only the four labiaplasty rows have dedicated pages so far; the clitoral-hoodoplasty / labia-majora / mons / vaginal-canal / energy-based-devices / hymenoplasty / regenerative rows still point to the placeholder genital-reconstruction-principles page). The 3-part Notes-column-drop rule does **not** apply until every row has a per-device page. Apply the male-cosmetic compression pattern only when the female-cosmetic per-device buildout reaches completion.

### Lint state

`npm run lint:links` clean across 835 files at every commit point.
