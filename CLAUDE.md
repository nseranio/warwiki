...
- Published GitHub collectors save literature and link-check artifacts on the first day of each month, at 06:23 UTC and 07:13 UTC respectively. Local Codex automation `warwiki-monthly-evidence-update` reviews and integrates meaningful verified changes on the second day. The local editor requires this computer/app running; catch up from the last completed update after missed runs.
