...
- [scalpel-handles](docs/01-foundations/tools/instruments/scissors/scalpel-handles.mdx) — handle numbering (#3 / #3L / #4 / #4L / #7 / #9), pencil-vs-palmar grip, Bard-Parker historical context. 12 refs.
- [scalpel-blades](docs/01-foundations/tools/instruments/scissors/scalpel-blades.mdx) — blade numbering (#10 / #11 / #15 / #15c / #20 etc.); Awadalla 2016 objective-sharpness data (force-to-cut in N); cold-steel vs energy-device wound-healing comparison (Sowa 1985, Sinha 2003, Kakarala 2010 oncologic-margin data); Mathilde Schott 1890 detachable-blade patent (Elson 2023 historical recovery). 13 refs.
