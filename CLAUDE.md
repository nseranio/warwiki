...
**Current audit continuation, September 12:** read [RESUME-HERE.md](RESUME-HERE.md), the [completion plan](reports/2026-09-12/completion-plan.md) and [current release record](reports/2026-09-12/second-continuation-release.md). The cumulative ledger now records 396 full documentation reads; all 95 pharmacology, 73 clinical-condition and 46 special-population pages have been read. The entire-site review remains active and incomplete. Publishing an intermediate correction batch is not task completion. Keep progressing through remaining source pages and inaccessible-source gaps; do not stop at a successful deployment. Earlier snapshots below are historical.
