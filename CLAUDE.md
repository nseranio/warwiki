...
### Ten new dedicated per-device pages under `04l-cosmetic-genital-surgery/`

| Tier | Page | Anchor evidence |
|---|---|---|
| **Labiaplasty** | [trim-labiaplasty.mdx](docs/04-surgical-techniques/04l-cosmetic-genital-surgery/trim-labiaplasty.mdx) (12 refs) | Zahedi 2023 trim-vs-wedge algorithm; Minikowski 2025 RCT n=48 (wedge≈trim on FGSIS/BDD); Escandón 2022 lower-dehiscence-than-wedge; Sharp 2016 preop-distress-predicts-satisfaction. Pattern: hyperpigmented edge / irregular edge / diffuse protrusion / smokers |
| **Labiaplasty** | [wedge-labiaplasty.mdx](docs/04-surgical-techniques/04l-cosmetic-genital-surgery/wedge-labiaplasty.mdx) (18 refs) | Alter 1998/2008 PRS hockey-stick landmark n=407 (2.9% reop, 9.2/10 satisfaction); Sinnott 2020 dehiscence risk factors (single-layer closure / concurrent mons lipo / active smoking); Köle 2024 multicentric n=2,594 (3.0% wedge vs 0.5% trim); Shi 2026 modified composite n=738. Multilayer closure mandatory |
| **Labiaplasty** | [de-epithelialization-labiaplasty.mdx](docs/04-surgical-techniques/04l-cosmetic-genital-surgery/de-epithelialization-labiaplasty.mdx) (9 refs) | Choi-Kim 2000 founding; Géczi 2024 highest pooled satisfaction (97%, 95% CI 85–99%); Escandón 2022 lowest dehiscence; Cao 2012 + Jiang 2021 + Wang 2025 modifications. Limited reduction capacity (mild–moderate only) |
| **Labiaplasty** | [laser-assisted-labiaplasty.mdx](docs/04-surgical-techniques/04l-cosmetic-genital-surgery/laser-assisted-labiaplasty.mdx) (18 refs) | Framed as **surgical tool, not technique**. FDA 2018 disambiguation admonition (cutting-tool ≠ "vaginal rejuvenation"). Géczi 2024: less bleeding/swelling/hematoma vs scalpel. Escandón 2022: highest dehiscence (5%, 95% CI 2–8%) from 100–500 µm thermal-coagulation zone. Pardo 2006 n=55 (100% sat, 7% minor dehiscence) |
| **Labiaplasty (hybrid)** | [combined-wedge-edge-labiaplasty.mdx](docs/04-surgical-techniques/04l-cosmetic-genital-surgery/combined-wedge-edge-labiaplasty.mdx) (10 refs) | Cao 2015 hybrid n=49 (42.9% unilateral; 100% sat; mean OR 56 min). For bi-dimensional hypertrophy + asymmetric/unilateral cases + dark-edge removal plus volume reduction. Composite extensions (Zhou 2022 trilobal, Xia 2021 three-step). Replaces prior mis-cited "Modified Wedge with Trim Component" row |
| **Hoodoplasty** | [inverted-y-clitoral-hoodoplasty.mdx](docs/04-surgical-techniques/04l-cosmetic-genital-surgery/inverted-y-clitoral-hoodoplasty.mdx) (8 refs) | Eserdağ 2021 founding n=63 (96.9% satisfaction; no major complications; OR 34 min alone, 45 min combined with curvilinear labiaplasty). Inverted-Y geometry produces lifting effect not achievable with simple longitudinal strip |
| **Hoodoplasty** | [liu-classification-hoodoplasty.mdx](docs/04-surgical-techniques/04l-cosmetic-genital-surgery/liu-classification-hoodoplasty.mdx) (9 refs) | Liu 2022 zone-based classification (5 types, Zone-C central / Zone-L lateral). **Largest hoodoplasty cohort published**: n=1,135 classified, n=789 treated (95.7% sat; 4.3% complications; 1.9% revision; **no paresthesia**). Bilateral triangular for wide hood (horizontal); inverted-V for long hood (vertical). Complementary to Xia 2022 CLC classification |
| **Hoodoplasty (composite)** | [three-step-two-part-composite.mdx](docs/04-surgical-techniques/04l-cosmetic-genital-surgery/three-step-two-part-composite.mdx) (10 refs) | Xia 2021 PRS three-step n=136 (hood ∥ labia majora → labial wedge → junction triangle; 95.5% sat; 70.9% sex life improved). Duan 2026 two-part n=68 (omits junction triangle; 92.6% sat; 1.5% revision). Not for fused-CLC variant (Xia 2022 Type 3 ~ 17.5% needs dedicated 4-step) |
| **Labia Majora** | [labia-majora-augmentation.mdx](docs/04-surgical-techniques/04l-cosmetic-genital-surgery/labia-majora-augmentation.mdx) (14 refs) | Jabbour 2017 SR principal synthesis. Indications: age-related atrophy, GSM, minora-to-majora ratio, post-surgical, post-PIV gender-affirming, aesthetic. Fat-processing (microfat / nanofat / MAFT / SVF). Outcomes: Cihantimur 2021 360 n=97; Menkes 2021 microfat+nanofat for GSM; Hersant 2018; Lai 2023 MAFT (FSFI 43.8→68.6 + histologic ER/neoangiogenesis); Patel 2021 post-PIV |
| **Labia Majora** | [labia-majora-reduction.mdx](docs/04-surgical-techniques/04l-cosmetic-genital-surgery/labia-majora-reduction.mdx) (11 refs) | Saheb-Al-Zamani 2022 principal synthesis. Three pathologies × three techniques (direct excision / liposuction alone / combined). Alter 2009/2012 post-bariatric with concurrent mons pexy. Lapalorcia 2013 HIV-lipodystrophy tailor-tacking. Bucknor 2018 7.3% concomitant rate. Reduction-vs-augmentation comparison table |
| **Mons Pubis** | [monsplasty.mdx](docs/04-surgical-techniques/04l-cosmetic-genital-surgery/monsplasty.mdx) (15 refs) | Hamdi 2023 JPRAS technique series + El-Khatib 2011 ptosis grading (recommend as standard component of abdominoplasty for Grade 2+). Three techniques (lipo / excisional / dermal-fascial suspension). Bloom 2012 + Bykowski 2017 post-bariatric outcomes (UDI-6 p=0.03; incontinence 22.6%→12.9%). Cross-link to buried-penis-repair |
| **Mons Pubis** | [fat-grafting-mons.mdx](docs/04-surgical-techniques/04l-cosmetic-genital-surgery/fat-grafting-mons.mdx) (16 refs) | Volume-restoration counterpart to monsplasty. Seleem 2023 normative volumes (mons ~200 mL normal BMI). Lai 2023 MAFT n=20 (FSFI 43.8→68.6 + histologic neocollagenesis/neoangiogenesis/ER). Menkes 2021 GSM (stable 18 mo). GRAFT registry overall complication 2.86%; ~16% need touch-up. Dong 2024 NMA: ADSC-assisted highest survival (SUCRA 82%) |

(The combined-wedge-edge / inverted-Y / Liu / three-step-two-part group sits at sidebar positions 20–23; labia-majora pair at 24–25; mons pair at 26–27.)

### Canonical Vaginal Laser Therapy page augmented with Er:YAG-specific evidence

[vaginal-laser-therapy.mdx](docs/04-surgical-techniques/04f-incontinence-procedures/procedures/vaginal-laser-therapy.mdx) (was 35 refs → now 46 refs). New Er:YAG anchors:

- **Gambacciani 2020** — 113,000-patient Er:YAG safety dataset (largest single dataset for any vaginal laser; no serious AEs).
- **Gaspar 2020** histology — vaginal epithelium 45 → 153 µm at 3 mo in severe atrophy.
- **Bayraktar 2024** sham-controlled shear-wave-elastography pilot n=20 (anterior wall 13.1 vs 20.0 kPa, p=0.01).
- **Phillips 2025 BJOG** sham RCT n=79 (62.7% vs 18.2% sham; positive).
- **O'Reilly 2024 IJGO** sham RCT n=110 (59% vs 36%; OR 3.63; positive).
- **Lee 2025 AJOG** double-blind sham RCT n=144 (negative — largest and most rigorous Er:YAG-SUI trial).
- **Sathaworawong 2022** Er:YAG vaginal-laxity sham RCT n=42 (transient ~3 mo benefit).
- Avul 2023, Lin 2022, Vizintin 2015, Menkes 2026 (Er:YAG + plant-derived exosomes pilot).

Explicit framing of the **registry-vs-MAUDE discrepancy** (113K with no serious AEs vs 33 chronic-injury MAUDE reports) — counsel patients in both directions.

### Cosmetic atlas database cleanup

- **Removed Vaginal Canal domain entirely** — Surgical Vaginoplasty / Vaginal Tightening + Perineoplasty rows deleted. Per ACOG 2020, "rebranding" colporrhaphy / perineoplasty as cosmetic is misleading; these are reconstructive procedures and live in 04g Prolapse Repair, not the cosmetic atlas. Removed `Vaginal Canal` badgeColor entry; removed the "Vaginal Laxity: Surgical vs Energy-Based" sub-comparison; removed the `Labiaplasty + vaginoplasty / perineoplasty` Combined Procedures bullet.
- **Energy-Based Devices domain collapsed to one row** — three rows (fractional CO₂, Er:YAG, RF) merged into a single **Vaginal Laser Therapy (Fractional CO₂ / Er:YAG / RF)** pointer row that links to the canonical 04f page rather than duplicating cross-indication content.
- Decision Framework matrix: kept GSM row; removed both vaginal-laxity rows.

### Editorial conventions reaffirmed / locked this session

- **Female-cosmetic per-device pattern** mirrors male-cosmetic: `sidebar_class_name: sidebar-hidden-item`; `:::warning[Society positioning]` admonition at top citing **ACOG 2020 Committee Opinion No. 795 + FIGO 2025 + ACOG 686 (adolescents)** (the female-cosmetic equivalent of male-cosmetic's SMSNA 2024). Locked page structure: definition → indications → technique table → modifications → outcomes → complications → comparative table vs siblings → postoperative management → See Also → References.
- **Tool-vs-technique distinction.** Laser-assisted labiaplasty (and other energy-based devices when used as cutting tools) is framed as a *tool* applied within other techniques, not as a separate technique. Comparison logic targets other tools (scalpel, RF, electrocautery), not other resection patterns.
- **FDA 2018 disambiguation as locked admonition pattern.** Any cosmetic-female page touching energy-based devices must explicitly distinguish *surgical-cutting-tool* use from *non-surgical "rejuvenation"* use, with a top-level "what the laser does / tissue removal / FDA clearance" disambiguation table.
- **Centralize energy-based-device cross-indication content** at [vaginal-laser-therapy.mdx](docs/04-surgical-techniques/04f-incontinence-procedures/procedures/vaginal-laser-therapy.mdx). Cosmetic atlas should hold one pointer row, not duplicated CO₂ / Er:YAG / RF rows.
- **Reconstructive procedures stay out of the cosmetic atlas.** Vaginoplasty (= colporrhaphy) and perineoplasty are reconstructive and live in 04g Prolapse Repair; they do not get cosmetic-atlas rows. Apply this rule when auditing other cosmetic atlases.
- **Database-row notes for cosmetic-female pages remain expanded** — the male-cosmetic 3-part Notes-column-drop rule does not yet apply because not every row has a per-device page (hymenoplasty / G-spot / regenerative rows are still placeholder pointers). Apply notes compression once the per-device buildout finishes.

### Per-technique anchor hierarchy (locked)

- **Trim** → Zahedi 2023 algorithm + Minikowski 2025 RCT + Escandón 2022 dehiscence data
- **Wedge** → Alter 1998/2008 PRS landmark + Sinnott 2020 dehiscence risk factors + Köle 2024 multicentric
- **De-epithelialization** → Choi-Kim 2000 founding + Géczi 2024 highest-satisfaction (97%) + Cao 2012 modification
- **Laser-assisted (cutting tool)** → FDA 2018 distinction + Pardo 2006 + Géczi 2024 tool-comparison + Escandón 2022 highest-dehiscence
- **Combined wedge-edge (hybrid)** → Cao 2015 hybrid + Zhou 2022 trilobal + Xia 2021 three-step
- **Inverted-Y hoodoplasty** → Eserdağ 2021 founding (n=63)
- **Liu-classification hoodoplasty** → Liu 2022 (n=789) + Xia 2022 CLC complement
- **Three-step / two-part composite** → Xia 2021 (n=136) + Duan 2026 (n=68)
- **Labia majora augmentation** → Jabbour 2017 SR + Cihantimur 2021 360 + Menkes 2021 microfat+nanofat for GSM + Lai 2023 MAFT
- **Labia majora reduction** → Saheb-Al-Zamani 2022 + Alter 2009/2012 post-bariatric + Bucknor 2018 7.3% + Siliprandi 2026 vulvar-aging classification
- **Monsplasty** → Hamdi 2023 + El-Khatib 2011 ptosis grading + Bloom 2012 + Bykowski 2017 + Kitzinger 2014 SFS suspension
- **Mons fat grafting** → Lai 2023 MAFT + Menkes 2021 + Cihantimur 2021 360 + Seleem 2023 normative volumes + GRAFT registry
- **Vaginal laser therapy (canonical)** → Li 2021 *JAMA* sham RCT + Cochrane 2025 + Lukanović 2026 + Phillips 2025/O'Reilly 2024/Lee 2025 SUI RCT trio + Gambacciani 2020 113K-pt Er:YAG safety
...
- **Female-cosmetic database compression (LOCKED, supersedes prior session note).** Notes column dropped entirely; "Genital Beautification Combined Packages" row deleted; all row names compressed to bare procedure names (e.g. "Trim (Edge / Linear) Resection Labiaplasty" → "Trim Labiaplasty"; "Three-Step / Two-Part Composite Excision (Lateral Hood + Labia Minora)" → "Three-Step / Two-Part Composite Excision"). Database now **2 columns (Procedure + Domain)**, mirroring the May-4 male-cosmetic compression. The bare-name + 2-column pattern is now applied consistently across both male and female cosmetic atlases.
- New per-device page **[g-spot-amplification.mdx](docs/04-surgical-techniques/04l-cosmetic-genital-surgery/g-spot-amplification.mdx)** (11 refs). Anchored on **Puppo & Gruenwald 2012** anatomic-existence-debate review (the central caveat — the G-spot may not exist as a discrete structure); ACOG 2020 + FIGO 2025 not-medically-indicated framing; **Clarke 2026 *Obstet Gynecol*** anterior-vaginal-wall PRP-vs-saline RCT n=52 (the closest available proxy — 69.2% vs 34.6% improvement at 6 mo, p=0.01; individual FSFI subscales did not reach significance); adjacent vaginal-augmentation literature (Yi 2026 / Lai 2023 MAFT / Menkes 2021 / Bensmail 2025 HA-for-VVA / CIVIT Leylek 2025). Explicit cosmetic-vs-therapeutic counseling distinction at the bottom (**G-shot ≠ HA-for-GSM**).
- New per-device page **[microfat-nanofat-grafting.mdx](docs/04-surgical-techniques/04l-cosmetic-genital-surgery/microfat-nanofat-grafting.mdx)** (24 refs). Therapeutic regenerative-medicine page covering GSM / VVA / refractory VLS. Anchored on **Tonnard 2013 PRS founding nanofat description**; **Menkes 2021** microfat (labia) + nanofat (vagina) n=50 (VHI/FSD stable at 18 mo); **Casarotti & Tremolada 2020** MFAT n=35 (99% complete symptom resolution at 9–12 mo; **no relapse at 36 mo**); **Lai 2023 MAFT** histologic anchor (neocollagenesis + neoangiogenesis + ER expression); **Gutierrez-Ontalvilla 2022 / 2025** RCT data for refractory VLS (Lichen-SVF protocol with histologic CD3+ T-cell reduction + microvascular density increase); **Wang 2020 fat-embolism case report** as the dominant safety concern. Explicit therapeutic-vs-cosmetic distinction (this is a therapeutic indication for GSM / VLS, not a cosmetic procedure — counsel and document accordingly). With this addition **every female-cosmetic database row now has a per-device page** (no slug-less placeholders remaining).

---

## Previous handoff snapshot — May 4, 2026 (cosmetic male database compression: notes column dropped + row names trimmed to bare procedure names)
...
### Arc 1 — BPH MIST + GreenLight PVP per-device completion

Five new dedicated atlas pages under `04m-bph-male-luts/`. The BPH atlas now has a per-device page for every major MIST plus the major resective / extirpative options. The locked architectural rule is **per-device split for products that differ on mechanism / indication / complication-profile / evidence-base**, with HoLEP as the **exception** — see Arc 2 (AEEP unification).

| Page | Refs | Headline anchors |
|---|---|---|
| [optilume-bph.mdx](docs/04-surgical-techniques/04m-bph-male-luts/optilume-bph.mdx) | 20 | **PINNACLE pivotal RCT** (Kaplan 2023; n=148; IPSS −11.5 / Qmax +10.3 mL/s +125% at 1 yr; 67.5% symptomatic responders at 2 yr); EVEREST-I 2-yr (Pichardo 2023); SUMMIT real-world (Siqueira 2026); Saffarzadeh 2025 device profile; Te-Kaplan 2025 balloon-prostatoplasty review; Wei 2025 *JAMA*; Cornu 2023 EAU NMA; Albayrak 2026 sexual / urinary outcomes; Shin 2024 BJU NMA; Passarelli 2025 Italian Delphi |
| [itind.mdx](docs/04-surgical-techniques/04m-bph-male-luts/itind.mdx) | 16 | **Chughtai 2021 pivotal RCT** (n=175; IPSS −9.25 / Qmax +3.5 mL/s at 12 mo); MT-02 3-yr durability (Porpiglia 2019 → Kadner 2020 → Amparore 2021 — IPSS −58% / Qmax +115%); MT-06 (De Nunzio 2021); Elterman 2023 sexual function; **Franco 2026 *Eur Urol* pooled MIST** (anejaculation ~ 1% — lowest of any MIST); Cornu 2023 EAU NMA; Passarelli 2025 Italian Delphi (high retreatment risk); Alghamlas 2026 median-lobe SR (do-not-offer rule); AUA 2023 Expert Opinion as TIPD |
| [urolift-pul.mdx](docs/04-surgical-techniques/04m-bph-male-luts/urolift-pul.mdx) | 21 | **L.I.F.T. RCT** (Roehrborn 2013 + 5-yr Roehrborn 2017; IPSS 50% at 12 mo / 36% at 5 yr); **MedLift FDA IDE extension** (Rukstalis 2019; OML safe and effective); Eure 2023 OML real-world; **BPH6 RCT** (Sønksen 2015 + Gratzke 2017; PUL inferior IPSS / Qmax to TURP but superior recovery + ejaculation); **Franco 2026** 0% anejaculation tied with iTIND; **Light 2021 Eur Urol NMA** (PUL ranked highest erectile function at 24 mo, MD 3.63); Cahill 2026 SR/meta; **Helman 2025 J Endourol MarketScan** (5-yr **22.3% real-world retreatment** vs trial 13.6%); Miller 2020 meta (annual 6.0%/yr); Gaffney 2021 (OR 1.78 vs TURP/PVP); Shin 2024 NMA (PUL ranked last for reintervention); **FDA MAUDE divergence** — Porto 2023 (PUL Level 3-4 23% vs Rezūm 7%); Weiss 2021 (50.6% Level 3-4 reports, primarily bleeding) |
| [aquablation.mdx](docs/04-surgical-techniques/04m-bph-male-luts/aquablation.mdx) | 24 | **WATER pivotal RCT vs TURP** (Gilling 2018; noninferior IPSS, safety-superior 26% vs 42% Clavien); **WATER II 5-yr final** (Bhojani 2023; large prostate 80–150 mL; **96.3% freedom from retreatment**); **WATER vs WATER II 5-yr equivalence** (Berjaoui 2024; outcomes consistent regardless of size); **WATER III** (Ritter 2026 vs LEP; **retrograde ejaculation 14.8% vs 77.1%**); Aldoukhi 2026 EAU Endourology Aquablation-vs-AEEP perspective; **Bettencourt 2025 SR** (antegrade preservation 72–99.6%); Plante 2019 anejaculation 10% vs 36% TURP; Perez 2025 prospective comparative (82.8% vs 36% TURP vs 18% HoLEP); **Bitar 2025 BJU Int** 70,270-case real-world (transfusion / takeback fulguration **0.2%**); Omidele 2024 single-center 4-yr 330 patients; **El Hajj 2022 learning curve** (trifecta by case 30); Bach 2022 single-vs-multi-pass; Shin 2024 NMA (Aquablation ranked 2nd behind TURP); Akgul 2025 SR (5-yr 4.4–6%); Teoh 2025 emerging localized prostate cancer + LUTS application |
| [greenlight-pvp.mdx](docs/04-surgical-techniques/04m-bph-male-luts/greenlight-pvp.mdx) | 31 | AUA 2023 **Moderate / Grade B** for 120 W / 180 W; **GOLIATH RCT** (Bachmann 2014/2015 + Thomas 2016 24-mo — noninferior to TURP for IPSS / Qmax / safety; faster recovery; early reintervention 3× higher after TURP); Lai 2019 22-study SR / meta (lower blood loss / transfusion / clot retention / TUR syndrome); Gill 2024 13-RCT meta (sexual dysfunction RR 0.66); **Law 2021 Global GreenLight Group** (mortality 0.3%, retreatment 1.5%, PSA reduction 46.4% at 60 mo); device evolution KTP / 120 W HPS / 180 W XPS with Wang 2024 head-to-head meta favoring XPS. **Anticoagulation niche:** Lee 2016 / Meskawi 2019 / Chung 2011 — safe on warfarin / DAPT / triple therapy without holding. **Elshal 2020 3-arm RCT 80–150 mL** (PVP **27% retreatment vs HoLEP 0% at 3 yr** — central limitation for very large glands). Sexual function: Abolazm 2020 RCT **ejaculatory hood-sparing 85% vs 31.6% standard**, p=0.001. GreenLEP enucleation extension: Wang 2025 13-study SR / meta, Misrai 2016, Bajic 2019 simplified-technique bridge |

The BPH database row for each was updated with canonical slug + sharper notes calling out the headline trial data, AUA guideline status, sexual-function-preservation framing, and real-world retreatment / safety divergence. The `drug-coated-balloon.mdx` page (urethral / ureteral DCB) and the original UroLift biomaterials page each got reciprocal disambiguation admonitions pointing to the new BPH atlas page. The HoLEP cross-link and the BPH-database "Ejaculation preservation" / "Office / ambulatory treatment" rows were repointed.

### Arc 2 — AEEP unification (HoLEP / ThuLEP / ThuFLEP / BipolEP)

**Architectural decision: ThuLEP, ThuFLEP, and BipolEP stay folded into the canonical [prostate-enucleation-holep.mdx](docs/04-surgical-techniques/04m-bph-male-luts/prostate-enucleation-holep.mdx) page** as energy-source variants of the same anatomical operation, rather than splitting onto separate pages. **Shoma 2023 BJU 3-arm RCT** directly supports the unification — HoLEP / ThuLEP / B-TUEP showed no significant difference in functional outcomes for the same operation. This preserves the locked WARWIKI structural pattern from the prior HoLEP-page handoff.

The page expanded from 41 → **71 DOI-linked refs** with a new **"Energy-source variants — ThuLEP, ThuFLEP, and bipolar enucleation"** section (between Outcomes and Anticoagulation). New evidence stacks:

- **ThuLEP / ThuFLEP / pulsed Tm:YAG** — Castellani 2020 / Becker 2021 thulium-AEEP rationale; Bozzini 2023 Tm:YAG vs CW TFL; **von Bargen 2025 pulsed solid-state Tm:YAG** vs HoLEP; **ESUT / T.R.U.S.T. 2023 expert survey** (Ho:YAG no longer mainstay; TFL by 50% of experts); **Bozzini 2021 RCT n=236 ThuLEP vs HoLEP** (Hb drop 0.45 vs 2.77 g/dL favoring ThuLEP; HoLEP higher AUR / SUI; equivalent functional outcomes); **Petov 2022 ThuFLEP n=1,328 3-yr** (IPSS 20.3 → 5.4); Huang 2019 *BMJ* NMA of 109 RCTs / 13,676 patients; Vo 2025 EEP-vs-TURP meta of 28 RCTs / 3,085 patients (reoperation RR 0.32).
- **ES-ThuLEP** — Bozzini 2021 (71.7% / 77.4% at 3 / 6 mo), Trama 2022 (88.6 / 92.4 / 94.3% at 3 / 6 / 12 mo), **Perri 2025 ES-ThuLEP-Tm:YAG-vs-TFL** (81% antegrade preservation), Guldibi 2023 SR (62.1% standard / 27.2% with sparing modifications); ThuLEP learning-curve cluster (Aydogan 2022 / Perri 2024 / Al Barajraji 2024 / Enikeev 2018 mentored 30 cases).
- **Bipolar enucleation (BipolEP / B-TUEP / B-TUERP)** — Ryang 2020 step-by-step; Giulianelli 2015 button technique; **Samir 2019 RCT n=240 ≥80 g** (B-TUERP at 24 mo: better IPSS / Qmax / PVR than B-TURP); Arcaniolo 2020 ESUT cumulative; Magistro 2021 matched-pair (HoLEP / B-TUEP tissue retrieval 71.4% / 70% vs TURP 50%); Bebi 2021 size-stratified; **Filomena 2023 J Endourol B-TUEP 10-yr n=50 (0% reoperation for persistent BOO)**; Lombardo 2021 vs LSP 3-yr; **Frendl 2021 claims-based real-world n=15,982 / 7-yr** (enucleation 6.7% cumulative failure vs TURP 15.3%); Kiss 2025 mushroom vs morcellation.
- **Shoma 2023 BJU 3-arm RCT (≥ 80 mL)** — HoLEP vs ThuLEP vs B-TUEP no significant difference; for **&gt; 120 mL** laser EEP (HoLEP / ThuLEP) better IPSS than B-TUEP (p = 0.01).

**BPH database row consolidated.** Prior two rows ('HoLEP' + 'Thulium / Bipolar Endoscopic Enucleation') merged into a single row: **"Anatomical Endoscopic Enucleation (AEEP) — HoLEP / ThuLEP / ThuFLEP / BipolEP"** with sharper notes anchored on AUA 2023 Moderate Grade B, Shoma 2023 3-arm RCT, Bozzini 2021 ThuLEP-vs-HoLEP Hb-drop differential, Petov 2022 ThuFLEP 3-yr cohort, Filomena 2023 B-TUEP 10-yr 0% reoperation, Frendl 2021 NSQIP comparative, **energy-choice-driven-by-equipment / cost / surgeon-expertise framing** (not clinical superiority).

### Arc 3 — Foundations urinary-catheter family rebuild

Five Foundations / `tools/biomaterials/urinary-catheters/` pages were rebuilt from brief stubs into comprehensive deep-dives, plus one page deleted with redirect.

| Page | Refs | Anchors |
|---|---|---|
| [foley-catheter.mdx](docs/01-foundations/tools/biomaterials/urinary-catheters/foley-catheter.mdx) | 17 | Cameron-Werneburg 2025 *JAMA Surg* (100M global / yr); Foley 1937 history (DuBose 2023, Feneley 2012); AAFP 2024 (Fletke); IDSA / SHEA / APIC 2022 update (Patel); Saint 2018 *JAMA Intern Med* multicenter PRO (57% complication rate, 55% noninfectious); Cochrane reviews on short-term catheterization (Phipps 2006, Kidd 2015, Lam 2014, Ellahi 2021); Lawrence-Turner 2006 silicone properties; **Liss 2009 maneuver** (+359% body stiffness); Willette 2012 difficult-cath algorithm; Boivin 2025 POCUS troubleshooting; AUA / SUFU NLUTD 2021 |
| [council-tip-catheter.mdx](docs/01-foundations/tools/biomaterials/urinary-catheters/council-tip-catheter.mdx) | 12 | Beaghler 1994 (96% bedside flex-cysto + Council success in 54 patients); Kim 2024 *Sci Rep* (100% fluoroscopy-guided in 179 procedures, 2.2% complications); See 1995 VUA suture landmark; Freid-Smith 1996 Glidewire (19/20); Liss 2009; Clayman 2004 guidewire comparison (4× tip-safety advantage of Glidewire); Wessells 2023 AUA stricture amendment; Bugeja 2019 UCD purpose-built device. Stripped two bleed-through cardiac-electrophysiology Figure 1 placeholders (Huang 2024 JACC, Krisai 2022 JACC) from the source. |
| [coude-catheter.mdx](docs/01-foundations/tools/biomaterials/urinary-catheters/coude-catheter.mdx) | 11 | **Miller 2024 *Urology*** institutional standardization (3.0% → 0.2% traumatic catheterization with universal coudé adoption — 93% relative reduction); **Chrouser 2024 URECA algorithm** (high-risk patients > 55 yr or with prostatic enlargement → safer catheter type / size, often coudé); Li 2021 / Cho 2008 prostatic-urethral-angulation pathophysiology (85–90° in severe BPH vs 60–65°); ACS 2025 GU-injury best-practices admonition (avoid coudé in suspected urethral injury; straight + RUG); Liss 2009; Willette 2012; Saint 2018 |
| [suprapubic-catheter.mdx](docs/01-foundations/tools/biomaterials/urinary-catheters/suprapubic-catheter.mdx) | 23 | **AUA / SUFU NLUTD 2021 Strong Grade C** (suprapubic preferred over urethral for chronic indwelling drainage); AUA / SUFU OAB 2024 (Cameron); Fletke 2024 AAFP; **Hobbs 2022 BJU Int** 1,000-elective-procedure series (Clavien ≥ IIIb 0.6%, no bowel injuries); **Perez 2025 within-subject** (CAUTI 86% → 38% transitioning to SPT); **Willging 2025 Urology** 10-yr longitudinal (59.9% complications, 28.8% obstruction; absence of ancillary treatments OR 56.8 for SPT discontinuation); **Tseng 2025 Taiwanese** n=72,971 (5.16× bladder-cancer risk on chronic catheter); **Hird 2021 Ontario** n=36,903 (HR 4.80 incidence / HR 8.68 cancer-specific mortality; risk highest > 2.9 yr); **Delnay 1999** SCI histology (8.2% malignancy / 23% premalignant > 8.5 yr); Flynn 2022 NBS-SPT large-caliber technique; Jacob 2012 ultrasound-guidance; Roberts 2020 trocar-vs-Seldinger; Chan 2020 hydrodissection; Cooper 2016 Cochrane replacement-interval data |
| [intermittent-catheter.mdx](docs/01-foundations/tools/biomaterials/urinary-catheters/intermittent-catheter.mdx) | 22 | AUA / SUFU NLUTD 2021 Strong Recommendation for CIC over indwelling; **Cochrane 2021 (Prieto)** technique / strategies / designs SR (no certain difference clean-vs-aseptic, single-vs-multi-use, hydrophilic equivocal); **Plata 2023 World J Urol meta** (RR 0.78 favoring hydrophilic adults); **Bermingham 2013 BMJ SR** (clean non-coated most cost-effective); **Fisher 2018 AnTIC trial** *Lancet Infect Dis* (48% UTI reduction with prophylaxis but resistance OR ~ 3 at 9-12 mo); **Wang 2022 AJOG** post-pelvic-surgery cost analysis ($79 ISC vs $128 IUC vs $185 office TVT); **Chrouser 2024 URECA** (ISC before IUC for POUR); **Krebs 2015** stricture rate 25% in male NLUTD on IC; Lindehall 2004 pediatric data; Neumeier 2023 IC-vs-IUC no-difference UTI signal; Chapple 2023 BVE consensus; Hudson 2005 / Goessaert 2013 / Meredith 2024 no-touch closed-system data |

**Deleted page.** `self-retaining-catheter.mdx` (Malecot / de Pezzer) — niche tip-expansion-retention catheters largely supplanted by Foleys for urinary drainage. Vercel redirect old slug → Foley page. References in biomaterials index, Foley See Also, and Suprapubic See Also removed.

### Arc 4 — Foundations surgical-drain family rebuild — urology-only scope rule

Three pages rebuilt under `tools/biomaterials/surgical-drains/` with explicit application of the **WARWIKI scope rule** — out-of-scope drain literature (breast / mastectomy, thyroid / ATA, orthopaedic, thoracic / pulmonary, cardiac / mediastinal, pancreatic / hepatobiliary, maxillofacial, head and neck) was **filtered out** of all three pages. Only generic device-physics work and urology-specific clinical evidence retained.

| Page | Refs | Anchors |
|---|---|---|
| [jackson-pratt.mdx](docs/01-foundations/tools/biomaterials/surgical-drains/jackson-pratt.mdx) | **42** | **Mamuyac 2019 Laryngoscope** (compression direction 87.4 side-in vs 17.7 bottom-up cm H₂O; full fill-effect curve with 25%-fill halving threshold); **Khansa 2018 PRS** optimal-use 7-pearl framework; Whitson 2009 / Grobmyer 2002 bench inter-device variability (−71 to −175 mmHg); Meyerson 2016 history; Swartz 2012 experimental clogging model; Thomson 2014 Cochrane groin dissection; IDSA 2024 microbiology guide. **Procedure-specific urology evidence stack:** **Yanagisawa 2023 BJU Int** RARP drain SR/meta (8 studies / 5,112 patients; drain omission ↓ ileus OR 0.70); **Kowalewski 2020 World J Urol** uro-onc drain SR/meta (n=3,664; RP drain omission ↓ complications OR 0.62); **Kirmiz 2020 MUSIC Collaborative** (6,746 RARPs / 115 surgeons — regular CSD ↑ LOS > 2 d OR 1.42 and ↑ ileus OR 1.64); **Scuderi 2025 Urol Oncol** environmental + cost (drain use 94% → 18% over 7 yr, no complication increase, drain ↑ opioid use OR 1.58, €18,506 / yr saved + CO₂ reduction); **Danuser 2013** lymphocele after ePLND + RP (transperitoneal robotic 1% protective vs open 7%); Araki 2006 / Sharma 2007 / Musser 2014 MSK / Chenam 2018 / Porcaro 2021 / Huang 2021 RP-no-drain stack; Sánchez-Ortiz 2004 / Kriegmair 2016 / Abaza 2013 / Beksac 2020 PN-no-drain stack; **Williams 2017 D/S creatinine ratio > 1.2 = urine leak** as the cardinal urology-specific test; **Woldu 2015 Urology serum cystatin C** to differentiate pseudoazotemia from true azotemia; Mahmud 2025 / Blachman-Braun 2025 / Meeks 2008 / Potretzke 2016 / Ghenassia 2026 / Kundu 2010 PN urine-leak risk and management ladder; Rich 2023 drainless RARC; Oh 2023 percutaneous post-RC drainage; Hagimoto 2023 nephroureterectomy; **Lakha 2024 SR/meta** + Derweesh 2008 + Noor 2023 + Kiberd 1999 transplant drain cluster; Chow 1998 ureteroneocystostomy (drain fluid creatinine consistent with serum, not urine); de'Angelis 2023 WSES IUTI guideline; Bellman 1994 endoscopic management of retained drains; Talwar 2024 NSQIP LOS signal |
| [blake-drain.mdx](docs/01-foundations/tools/biomaterials/surgical-drains/blake-drain.mdx) | 23 | Channel-design rationale (no perforations → no tissue ingrowth pathway, less clogging in debris-rich fluid); same urology-specific evidence stack as JP page (Kowalewski / Yanagisawa not duplicated, but procedure-specific RP / PN / RC / NU / transplant tables present); Blake-favoring scenarios (long dwell, debris-rich output, removal-comfort priority) |
| [penrose-drain.mdx](docs/01-foundations/tools/biomaterials/surgical-drains/penrose-drain.mdx) | 13 | **Raves 1984 rabbit-model bacteriologic study** (90% positive intraperitoneal cultures with Penrose vs 0% control vs 20% JP — landmark evidence for retrograde bacterial migration); Mujagic 2019 (open drains 3.68× SSI risk vs closed); **Sánchez-Ortiz 2004** Penrose-vs-closed-suction after PN (n=197; no significant differences); **Jou 2004** tubeless PCNL (Penrose as overnight tract drain after cauterization + DJ stent — niche where Penrose still earns a place); Chow 1998 ureteroneocystostomy; Lakha 2024 / Derweesh 2008 transplant cross-link; Kowalewski 2020 drainless paradigm |

### Editorial conventions reaffirmed this session

- **Per-device pattern is locked for the BPH section** — but with one explicit exception: **HoLEP / ThuLEP / ThuFLEP / BipolEP all live on the same canonical AEEP page** because the underlying anatomical operation is identical and the energy-source choice is driven by equipment / cost / expertise rather than clinical superiority (Shoma 2023 BJU 3-arm RCT). Every other major BPH MIST and resective / extirpative option has its own dedicated page. The chooser landing's MDF + database now point at canonical URL targets for every row.
- **The per-device-vs-unified-page decision rule** is therefore: split when the products differ on **mechanism + indication + complication-profile + evidence-base** (Optilume BPH, iTIND, Rezūm, UroLift, Aquablation, GreenLight PVP, PAE, Simple Prostatectomy); **unify** when the underlying operation is identical and only the energy source differs (HoLEP / ThuLEP / ThuFLEP / BipolEP — all are AEEP).
- **Out-of-scope filtering is rigorous when source material spans multiple specialties.** When a chatbot-augmented source provides drain / catheter / device data heavy on breast / thyroid / orthopaedic / thoracic content, the WARWIKI scope rule is invoked: cut to generic device-physics + urology-specific clinical evidence, even if it means dropping > 50% of the source bibliography. Document the filtering rule in the opening paragraph and in the commit message so the editorial decision is traceable.
- **Drain creatinine is the cardinal urology-specific drain test.** D/S ratio > 1.2 = urine leak (Williams 2017 RAPN data). Cystatin C distinguishes pseudoazotemia from true azotemia (Woldu 2015). Both belong on the canonical JP / Blake pages.
- **The drain-omission paradigm is the modern direction across uro-oncology.** Kowalewski 2020 (n=3,664), Yanagisawa 2023 RARP meta (n=5,112), Kirmiz 2020 MUSIC (n=6,746) are the three meta / large-cohort anchors. Drains remain appropriate for uncertain anastomosis, complex PN with collecting-system entry, prior radiation, complex fistula, posterior urethroplasty, and large dead-space reconstruction.
- **Per-device atlas pages should cite the same anchor papers when applicable** rather than referring readers between pages — surgeons read per-device pages standalone. Some duplication of evidence anchors (Cornu 2023 EAU NMA, Sandhu 2024 AUA Amendment, Franco 2026 *Eur Urol* pooled MIST, Shin 2024 BJU NMA, Albayrak 2026, Wei 2025 *JAMA*) across BPH MIST per-device pages is expected and desirable.
- **Reciprocal disambiguation admonitions** when a single device platform serves two distinct indications (Optilume urethral DCB ↔ Optilume BPH; UroLift Foundations device profile ↔ UroLift BPH atlas page).
- **Chatbot-source filtering checklist** (now standard, applied 8+ times this session): strip "Would you like to explore..." trailing prompts; strip Figure N / undefined placeholders (especially the cardiac-electrophysiology Figure 1 bleed-throughs in council-tip source); convert `[N]` to `<sup>[[N]](#refN)</sup>`; rebuild mashed tables; reconstruct swallowed `<` artifacts; renumber refs sequentially; cross-check every cited ref is actually used in body and matches the claim it supports; filter bleed-through references.
- **Database row names should be conversational short identifiers** — not full official names. Surgeons think "TURP" not "Transurethral Resection of the Prostate (TURP)"; "Aquablation" not "Aquablation (AquaBeam)"; "Simple Prostatectomy" not "Robotic / Open / Laparoscopic Simple Prostatectomy". The descriptive depth lives in the column data and on the per-device page. Applied to the BPH database this session.
- **Database rows must be mobile-readable.** A row should fit a single short tap-target on mobile. Notes / volume / anatomy / sexual fields should be ≤ ~ 50 chars where possible. Aggressive evidence dumps (RCT names, n values, percentages, citation chains) belong on the per-device page, not in the row. Applied to BPH this session — notes column eventually dropped entirely.
- **Notes-column drop decision rule (3-part).** When auditing a section's database for the "do we need notes?" question, drop the column when **all three** are true: (a) every row has a dedicated full-depth page; (b) the other comparative columns (volume / anatomy / sexual / mechanism / etc) already triage which page to click into; (c) the notes content is redundant with what's already on the per-device page (i.e., it would drift out of sync over time). **Keep notes when:** (a) many rows are slug-less plain-text entries (instruments index, biomaterials index — Notes is the only home for the differentiator); (b) it's a pointer database aggregating cross-cutting framing not found elsewhere (04i Tissue Transfer is the canonical example); (c) the row is the canonical home of the comparison (small reagent / dose / stain comparison tables). **Audit case-by-case when touching a section** — don't do a blanket-wide drop. BPH was the right call because every row had a per-device page; most other sections don't yet. Audit candidates already noted: 04a urethral, 04ab BNC, 04h fistula, 04d upper tract, 04b bladder augmentation are likely-drop; 04i tissue transfer, 04k GAS, 04l cosmetic, instruments / biomaterials index, 04e genital reconstruction are likely-keep.

### Lint state

`npm run lint:links` clean across 808–817 files at each commit point. Citation lint clean for all new and rebuilt pages this session. Build not re-run end-to-end given file-creation volume; recommended next session.

### Arc 5 — TURP / TUIP per-device pages, AEEP rename, cosmetic atlas split, sexual-medicine device rebuilds (continuation)

After the major drain / catheter / BPH-MIST work above, the same session extended the per-device pattern to the remaining BPH resective options, the cosmetic-genital-surgery section, and the male-sexual-dysfunction device family.

| Page | Refs | Headline anchors |
|---|---|---|
| [turp.mdx](docs/04-surgical-techniques/04m-bph-male-luts/turp.mdx) | 21 | **Reich 2008 Bavarian** n=10,654 (30-d mortality 0.10%); **Cochrane 2019 Alexander** M-vs-B-TURP (TUR syndrome 18 vs 3 per 1,000); **Wei 2025 *JAMA*** comparative; **Franco 2021 Cochrane NMA** (TURP as reference comparator); Mayer 2012 three-decade temporal-improvement; **He 2023 SR** n=130,106 retreatment 7.7% at 5 yr; Frendl 2021 real-world 15.3% at 7 yr; **Nackeeran 2025 VA** post-2001 OR 1.49 retreatment (trainee-volume signal). |
| [tuip.mdx](docs/04-surgical-techniques/04m-bph-male-luts/tuip.mdx) | 18 | **Yang 2001 SR/meta** of 9 RCTs / 795 pts; **Riehmann 1995 RCT** ("underutilized procedure" framing; RE 35% vs 68%, p=0.020); Christensen 1990 RCT; Sirls 1993 long-term; **Wei 2025 *JAMA*** comparative; **He 2023 SR** TUIP retreatment 13.4% at 5 yr; **Sinha 2026 ESBNI** (100% antegrade preservation with 10 mm proximal-to-veru distal limit); **PBNO evidence stack** (Trockman 1996, Kaplan 1994 — 100% antegrade ejaculation in 31 men misdiagnosed as chronic nonbacterial prostatitis); Elshal 2014 holmium TUIP vs PVP cost differential. |

**AEEP rename** (commit `4c90538`): article title and database row renamed `"Prostate Enucleation / HoLEP"` → `"Anatomical Enucleation of the Prostate"`; slug preserved. Database row renamed from `AEEP` → `Anatomical Enucleation of the Prostate` per the explicit "no acronyms" instruction.

**Database row name shortening** (commit `743bd5f`): every BPH database row trimmed from full official name to conversational short identifier — TURP / TUIP / Aquablation / Simple Prostatectomy / UroLift / Rezūm / iTIND / Optilume BPH / PAE / Catheter Pathway / GreenLight PVP. Then AEEP row renamed to "Anatomical Enucleation of the Prostate" specifically.

**Mobile-readable row compression** (commit `97741eb`): every BPH database row compressed from 400–900 char notes to ~100–150 char one-or-two-data-point one-liners. Then **notes column dropped entirely** (commit `e834179`) — the Volume / Anatomy / Sexual columns already triage which page to click into; Notes was redundant with the per-device pages.

**Database design conventions** captured in CLAUDE.md (commit `1e51502`):

- **Short conversational row names** (TURP not "Transurethral Resection of the Prostate (TURP)").
- **Mobile-readable rows** (≤ ~50 chars per field where possible; evidence dumps belong on per-device page).
- **Notes-column drop decision rule (3-part):** drop when (a) every row has a per-device page, (b) other columns already triage, (c) notes content is redundant with per-device page. Keep when (a) many slug-less rows, (b) pointer database aggregating cross-cutting framing, (c) row is canonical home of the comparison. **Audit case-by-case when touching a section** — don't blanket-drop. BPH was right because every row had a page; most other sections aren't yet. Likely-drop candidates: 04a urethral, 04ab BNC, 04h fistula, 04d upper tract, 04b bladder augmentation. Likely-keep: 04i tissue transfer, 04k GAS, 04l cosmetic, instruments / biomaterials index, 04e genital reconstruction.

### Arc 6 — Sexual medicine devices and cosmetic genital surgery deep-dives

Five dedicated pages added / rebuilt across the male sexual dysfunction (04j) and cosmetic genital surgery (04l) sections:

| Page | Refs | Headline anchors |
|---|---|---|
| [penile-traction-therapy.mdx](docs/04-surgical-techniques/04j-sexual-dysfunction/penile-traction-therapy.mdx) | 18 (rebuild) | **Sultana 2022 Nat Rev Urol** PTT/VED indications review; Trost 2016 ICSM consensus; Cochrane 2023 (Rosenberg) PD non-surgical SR; **Ziegelmann 2019 RestoreX RCT** (+1.5 cm length, −11.7° curvature); Joseph 2020 OLE 6-mo durability; **Moncada 2019 Penimaster PRO RCT** dose-dependent (>6 h/d → −38.4° / +1.8 cm); **Toussi 2021 RestoreX post-RP RCT** (+1.6 cm length preservation); Levine 2011 / Moskovic 2011 pre-/post-IPP optimization; **Nowroozi 2015** AndroPenis cosmetic; **Romero-Otero 2021 BJU Int SR** (PTT only evidence-based non-surgical lengthening). |
| [ved.mdx](docs/04-surgical-techniques/04j-sexual-dysfunction/ved.mdx) | 31 (rebuild from stub) | **AUA 2018 ED Guideline** (Burnett); **Yuan 2010 Int J Impot Res** mechanism (VCD with ring vs VED without ring distinction); **Zhang 2025 SR/meta** of 18 studies / 1,065 pts (refractory ED 80% pooled efficacy); etiology-specific table (post-RP 84.5% / DM 73.0% / SCI 71.8%); **Pirola 2024 Int J Impot Res** post-RP scoping review; Feng 2022 SR/meta; Nauta 2025 academic penile-rehab program; **Ralph 2017 CCH+VED RCT** for PD; **Tsambarlis 2017** severe corporal fibrosis n=13 (all 13 successful IPP placements after VED prep); **Antonini 2020** post-IPP 1-yr (length 14→17 cm, **girth 9→11 cm** — VED's unique advantage over PTT). |
| [hyaluronic-acid-filler.mdx](docs/04-surgical-techniques/04l-cosmetic-genital-surgery/hyaluronic-acid-filler.mdx) | 17 | **SMSNA 2024 Position Statement** investigational framing + counseling-first rule; Salloum 2021 SR; Manfredi 2022 narrative; **Yang 2019/2020 RCT triad** HA vs PLA; **Zhang 2022 Asian J Androl** n=38 12-mo (+2.44 cm flaccid girth, IIEF +7.6); **Boiko 2023 Aesthet Surg J** n=132 (psychosocial-improvement-does-NOT-correlate-with-size-change framing); **Moon 2025 Int J Impot Res** penile-HA hyaluronidase reversibility case series; Yordanov 2021 secondary-deformity correction. Critical danger admonition distinguishing HA from unapproved oil-based injectables (sclerosing lipogranuloma). |
| [polylactic-acid-filler.mdx](docs/04-surgical-techniques/04l-cosmetic-genital-surgery/polylactic-acid-filler.mdx) | 22 | **Yang 2017 Int J Impot Res** PLA monotherapy founding 18-mo cohort; **Yang 2019/2020/2020 head-to-head RCT triad** vs HA (HA > PLA at 4 wk but NS at 48 wk; both maintain at 18 mo); biostimulatory-mechanism stack (Vleggaar 2014, Haykal 2025, Oh 2023, Huth 2024); **Wortsman 2025 international ultrasound study** (PLA = 18.8% of all filler-related granulomas); **Alijotas-Reig 2009** late-onset immune-mediated reactions (mean latency 19.2 mo). **Critical non-reversibility** danger admonition. |
| [suspensory-ligament-division.mdx](docs/04-surgical-techniques/04l-cosmetic-genital-surgery/suspensory-ligament-division.mdx) | 20 | **SMSNA 2024 Position Statement** (Trost 2024); **Mariani 2024 Aesthet Surg J** 49-cadaver topographic anatomy; **Ramos 2024** cadaveric morphometric (n=16; +26.4 mm; r=−0.601 negative correlation with baseline length); 5 surgical-technique approaches (V-Y / Shaeer T-closure / **Mertziotis 2013 V-Y vs circumcision** with 51% vs 0% hypertrophic scarring / Karimian 2026 trans-scrotal / Zhang 2019 SLD+ADM); **Aboul Fotouh 2022 J Sex Med RCT** n=61 SLD+IPP; **Wessells 1996 referral series** honest complications anchor (33% scrotalization, 33% sexual dysfunction, 50% reoperation); **Li 2006 Eur Urol satisfaction anchor** (35% overall / 27% PDD); the disconnect-between-objective-gain-and-subjective-satisfaction framing as the central counseling point. |
| [suprapubic-lipectomy.mdx](docs/04-surgical-techniques/04l-cosmetic-genital-surgery/suprapubic-lipectomy.mdx) | 28 | Bridges cosmetic atlas with [Buried Penis Repair (04e)](docs/04-surgical-techniques/04e-genital-reconstruction/buried-penis-repair.mdx) and [Buried Penis (clinical condition)](docs/03-clinical-conditions/03g-genital-scrotal/buried-penis.mdx). 4 procedure tiers (liposuction / open lipectomy / escutcheonectomy / panniculectomy). **Ghanem 2017** standalone liposuction; **Shaeer 2018** simultaneous SPL+IPP (+53.3% length satisfaction); **Loh-Doyle 2023** + **Baumgarten 2019** SPL+IPP series; **Pariser-Santucci 2018 staging**; **PAS 2023 classification** (Schlaepfer); **Fuller 2017** escutcheonectomy + STSG; **Strother 2018** STSG-from-excised-escutcheon; **Plamadeala 2026 European multicentre** n=204 (+3.0 cm SPL, 86.8% satisfied, 12.7% recurrence); **Staniorski 2023** frailty (mFI ≥ 2 OR 6.41 for complications); **Azab 2021** cryolipolysis as non-invasive alternative (~ 0.78 cm gain). |

The cosmetic-male database now has 4 dedicated per-device pages (HA filler, PLA filler, SLD, suprapubic lipectomy) with the others (Penuma, autologous fat, Z-plasty, Hardrock Sandwich Technique) still pointing to small-penis-syndrome.mdx pending dedicated pages.

---

## Previous handoff snapshot — May 2–3, 2026 (Male SUI containment + adjustable-device + sling restructure; canonical Bladder Neck Closure; biofeedback consolidation; Rezūm BPH page)
...
### Arc 1 — Male urethroplasty database pruning + redundancy merges

- **Removed three rows from male-urethroplasty database**: Lingual Mucosal Graft, Tissue-Engineered Oral Mucosa (MukoCell), Penile Skin / Inner Preputial Free Graft. ([commit 79fce6a](https://github.com/nseranio/warwiki/commit/79fce6a))
- **Subsumed Single-Stage Preputial Flap (Dorsal Onlay) → Quartey Flap** ([commit 352a541](https://github.com/nseranio/warwiki/commit/352a541)). Ported the unique RCT cluster (Tyagi 2022 PeeBuSt, Alrefaey 2025) and Hussein 2011 penile-circular-graft-vs-flap data into a strengthened "Quartey vs BMG urethroplasty" section on [quartey-flap.mdx](docs/04-surgical-techniques/04a-urethral-reconstruction/flap/quartey-flap.mdx) (3 new refs). Deleted the umbrella file. Vercel redirect from old slug → Quartey. Removed the row from the male-urethroplasty database.
- **Subsumed Y-V Glans Flap stub → Meatotomy & Meatoplasty** ([commit 2a0528d](https://github.com/nseranio/warwiki/commit/2a0528d)). Expanded the existing Y-V meatoplasty (Sennert / Hadidi 2025) subsection in [meatotomy.mdx](docs/04-surgical-techniques/04a-urethral-reconstruction/meatal-perineal/meatotomy.mdx) with the 5-step technique, scar-ring-interruption principle, and the **Kim & King 1992** dorsal-V-flap precursor (new ref28). Vercel redirect; row removed from database.
- **Removed three flap rows from male DB**: Singapore Flap Urethroplasty, Propeller Flap Urethroplasty, Lotus Petal Flap Urethroplasty ([commit bd8f52b](https://github.com/nseranio/warwiki/commit/bd8f52b)). Standalone foundations / urethroplasty-specific pages remain reachable from Blandy PU and 7-flap PU cross-links.

### Arc 2 — Female endoscopic management consolidation

- **Combined Female DVIU + Female Dilation into one page** ([commit 8df997c](https://github.com/nseranio/warwiki/commit/8df997c)). New [female-dviu-dilation.mdx](docs/04-surgical-techniques/04a-urethral-reconstruction/female/female-dviu-dilation.mdx) (11 refs anchored on AUA 2023, Bouchard 2025, Turchi 2026, Sarin 2021 meta, Osman 2013 SR, Chakraborty 2022, Waterloos 2019, Blaivas 2012). Mirrors the male DVIU/dilation pattern. Two old stubs deleted; two Vercel redirects; F1 database row merged; decision-framework cross-link repointed.

### Arc 3 — Drug-coated balloon female-data section

- **"Female Urethral Stricture — Limited and Low-Quality Evidence" section** added to [drug-coated-balloon.mdx](docs/04-surgical-techniques/drug-coated-balloon.mdx) ([commit 8df997c](https://github.com/nseranio/warwiki/commit/8df997c)). Honest framing of the female DCB literature as **2 case reports + 1 12-pt AUA abstract** — Stuehmeier 2021 (n=1, 50-yo, sphincter-involving stricture, Qmax 26 mL/s at 6 mo); Jelisejevas 2025 AUA abstract (n=12, ~ 90% recurrence-free; conference abstract only); Thomas 2025 (n=1, distal stricture, Sunnybrook reconstructive group). 3 new refs. Explicit caveat: AUA 2023 recommends urethroplasty over repeat endoscopic management in women, and that should not be overridden by anecdotal DCB data.

### Arc 4 — Female urethroplasty + SUI article fill-out (15 articles, plus a behavioral-therapy generalization)

**Behavioral Therapy renamed and generalized for both SUI and OAB / UUI** (this commit). The existing `behavioral-therapy-oab-uui.mdx` was `git mv`'d to `behavioral-therapy-incontinence.mdx` (slug `/procedures/behavioral-therapy-incontinence`); title updated to "Behavioral Therapy for Urinary Incontinence" and the opening paragraph generalized to cover the full SUI / OAB / UUI / mixed-UI spectrum with explicit phenotype-specific emphasis (bladder training and urge suppression strongest for OAB / UUI; weight loss + fluid / caffeine + constipation control strongest for SUI). The female SUI database "Behavioral & Lifestyle Modifications" row now points to the same shared page (and its notes were tightened to call out the SUI-vs-UUI bladder-training-evidence asymmetry); inbound links from PFES, weight-loss, OAB / UUI database, and clinical-conditions urgency-incontinence-oab.mdx all repointed; Vercel redirect added.

All from stub → full deep-dive. Each filtered for bleed-through DCB / unrelated refs and trailing chatbot questions; cross-linked into the female ladder.

| Article | Commit | Anchor evidence |
|---|---|---|
| **Distal urethrectomy with advancement meatoplasty** | [8df997c](https://github.com/nseranio/warwiki/commit/8df997c) | 16 refs anchored on the **1.5 cm sphincter-resection rule** (Reid 1990 / Hampl 2011 / Colleselli 1998), Bouchard 2025, Faiena 2016, Higuchi 2026, Lange 2022 / de Lorenzi 2015 oncologic / Blaivas 2012, AUA 2023. V-Y inset to avoid circumferential suture line. |
| **Blandy U-Flap (Female Vaginal Flap Urethroplasty)** | [2796559](https://github.com/nseranio/warwiki/commit/2796559) | 22 refs anchored on Romero-Maroto 2018, Hajebrahimi 2019, Gormley 2010, Simonato 2010, Blaivas-Heritz 1996 / Blaivas 1989 / Flisser-Blaivas 2003 / Blaivas 2012, Higuchi 2026 (29% spraying signal), Bouchard 2025, Li 2026 dorsal-vs-ventral meta. The **retrusive-meatus / inward-stream** as the defining limitation of the proximal-pedicled design. |
| **Lateral-Based Anterior Vaginal Wall Flap (Romero-Maroto / Simonato)** | [7e97dd6](https://github.com/nseranio/warwiki/commit/7e97dd6) | 16 refs anchored on Romero-Maroto 2018 (n=9, 100% at 80.7 mo), Simonato 2010 (n=6, 83% at 70.8 mo, **partial-de-epithelialization fistula prevention**), Orandi 1968 (founding male technique adapted), Önol 2011 Martius-reinforced ventral BMG for prior MUS scarring, Higuchi 2026 spraying contrast, Kumar 2025 BMG-vs-VWG meta showing equivalence (86.2% vs 89.8%). |
| **Anterior Vaginal Wall Mucosal Inlay (Önol)** | [ea66bd1](https://github.com/nseranio/warwiki/commit/ea66bd1) | 22 refs anchored on Önol 2011 (n=10 of 17, 100% objective at 24 mo, Qmax 10.8→28.9 mL/s, PVR 120→30 mL), Schwender / Gormley 2006 simplified inlay variant (n=8, 100% subjective, 0% SUI), Borchert 2022 vaginal-free-graft dorsal-onlay variant for the pedicled-vs-free distinction, Khawaja 2022 / Berdondini 2024 / Savun 2026 / Jena 2025 (n=200+ labial-mucosa) BMG-arm data. |
| **Urethral Diverticulectomy** | [16ad042](https://github.com/nseranio/warwiki/commit/16ad042) | 20 refs covering all 7 major techniques (standard 3-layer transvaginal, **Osman/Chapple prone jack-knife n=121: 73% continence / 4% recurrence**, **Lask bipedicle double-opposing fascial flaps n=17 UD>4 cm 0% recurrence at 5 yr**, Rovner/Nickles circumferential transection-and-reconstruction, **Spence-Duckett ± Welch modification** for distal UD only, Chen 2025 partial-excision conversion, Alphs male UD by defect length). **Bradley 2020 multicenter** PVS-vs-no-PVS data (aOR 2.27 SUI improvement vs OR 6.98 retention / 3.27 UTI). 3-Ds-no-longer-reliable, MRI-as-gold-standard, **OR 7.97 circumferential-recurrence** anchor, 2-9% malignancy rule. |
| **Female Dorsal Onlay Urethroplasty** | [a2ce7d5](https://github.com/nseranio/warwiki/commit/a2ce7d5) | 17 refs anchored on **Jena 2025 (n=204 labial mucosa, 93.5% at 2 yr — largest single-surgeon series)**, Richard 2021 (n=19 oral mucosa, 89.5%, Qmax 7.4→15.2 mL/s, PVR 161→72 mL), Higuchi 2026 (87.5% DOBMGU vs 57.1% VFU same series), Khawaja 2022 (>90% in 25 BMG), Savun 2026 multicenter (92.1% dorsal patency), Gomez 2020 pooled (~86%), Borchert 2022 vaginal free-graft variant, Mittal 2021 meatal-sparing modification, Kuo 2024 supraurethral approach. Quilting + 3-week catheter; rare spraying vs ventral approaches. |
| **Female Ventral Onlay Urethroplasty (NEW dedicated page)** | [6aa8e0e](https://github.com/nseranio/warwiki/commit/6aa8e0e) | 16 refs. Created [female-ventral-onlay-urethroplasty.mdx](docs/04-surgical-techniques/04a-urethral-reconstruction/female/female-ventral-onlay-urethroplasty.mdx) parallel to the female dorsal page so the F4 database row no longer overloads the male `ventral-onlay-omg` article. Berdondini 2024 (n=42 BMG, 98% at 38 mo, Qmax 7.7→25.9 mL/s, 0% incontinence), Mukhtar/Greenwell 2017, Savun 2026 multicenter (less bleeding 10 vs 20 mL p=0.001), Ozlulerden 2020 modified "AZ" (100% n=7, 64-min OR), Romero-Maroto 2018 lateral-based vaginal flap (100% at 80.7 mo), **Waterloos/Lumen EAU 2025 (n=132 ventral, prior radiotherapy as the sole independent predictor of recurrence p=0.015)**, Katiyar 2021 RCT, Ortac 2025 / Li 2026 metas showing dorsal-vs-ventral equivalence. |
| **Female Ventral Inlay BMG (Mandal RCT)** | [ed4c414](https://github.com/nseranio/warwiki/commit/ed4c414) | 10 refs anchored on Gaur 2024 (n=46 vaginal-sparing VIBMGU, 89.1% with follow-up to 90 mo — **largest series**), **Mandal 2025 RCT** (n=20 vs DOBMGU: 95% both arms, OR **30 vs 44.5 min p<0.001**, blood loss **10 vs 15 mL p=0.012**, less pain, 0% SUI), **Kumaraswamy 2022 life-table** (n=21, 95% at 1 yr, **85% sustained at 2-5 yr**), **Sterling/Nikolavsky 2023 transurethral variant** (n=44, 95% at 36 mo, **same-day discharge, 1-wk catheter**, 0% complications). Inlay-vs-onlay distinction (no vaginal-wall incision, no fascial flaps, native periurethral bed support). |
| **Female Dorsal Inlay BMG (NEW)** | [4c89e3b](https://github.com/nseranio/warwiki/commit/4c89e3b) | 10 refs. Created [female-dorsal-inlay-bmg.mdx](docs/04-surgical-techniques/04a-urethral-reconstruction/female/female-dorsal-inlay-bmg.mdx) anchored on **Jefferson 2025** (n=21 transurethral dorsal-inlay BMG, **95% at 4 mo / 92% at 12 mo, median OR 60 min, same-day discharge, 0% complications, 0% SUI**), **Linder 2022** first transurethral case (nasal speculum + suture-passing device + tissue adhesive), Tsivian-Sidi 2006 founding suprameatal description, Petrou 2012 (n=11 vaginal-graft suprameatal inlay, 100% at 22.7 mo). The **0%-SUI-vs-9-16%-dorsal-onlay** rationale = preservation of periurethral support via minimal mobilization. New F4 database row added. |
| **Continence Pessary (NEW)** | [01e922f](https://github.com/nseranio/warwiki/commit/01e922f) | 12 refs at [continence-pessary.mdx](docs/04-surgical-techniques/04f-incontinence-procedures/procedures/continence-pessary.mdx). Anchored on Wu 2021 *NEJM*, Todhunter-Brown 2022 Cochrane overview, Lukacz 2017 *JAMA* review, ACOG PB 155 (Level B), Richter 2010 RCT (33% pessary vs 49% PFMT at 3 mo; no significant difference at 12 mo), Lipp 2014 Cochrane (46% met ≥75% reduction at 3 mo), Rantell 2025 IUC pessary chapter, Sethi 2025 modern pessary review (3D-printed, hormone-releasing). Mechanism (knob compresses urethra against pubic symphysis), device types (provider-fitted; **Impressa OTC**, **Uresta telehealth**), fitting principles (ring as first choice, finger-sweep test, success 41–96.6%), follow-up cadence (3 mo first year, then 6 mo), efficacy framing (~33–46% short-term, ~50% continue at 1–2 yr; **PFMT > pessary alone, PFMT + pessary > pessary alone, combination not clearly superior to PFMT alone**), complications (10–29% erosion long-term, 8.6% paradoxical worsening, rare neglected-pessary serious complications). SUI database row updated with slug + tighter notes; decision-framework and stepwise-ladder cross-links repointed. |
| **Burch Colposuspension (NEW)** | [813d9c8](https://github.com/nseranio/warwiki/commit/813d9c8) | 17 refs at [burch-colposuspension.mdx](docs/04-surgical-techniques/04f-incontinence-procedures/procedures/burch-colposuspension.mdx). Anchored on **Wu 2021 *NEJM*** (74% pooled cure vs 82% MUS), **Albo 2007 *NEJM* SISTEr trial** (Burch 38% overall / 49% stress-specific vs autologous fascial sling 47% / 66% at 24 mo), **Brubaker 2006 *NEJM* CARE trial** (Burch reduces post-SCP SUI **44% → 24%**), **Karmakar 2021** (n=1,344 mean 13.1 yr — Burch and retropubic MUS equivalent in success / satisfaction / reoperation; PGI-I 84.1% vs 82.0%), Lapitan 2017 / Freites 2019 / Baessler 2026 Cochrane reviews, ACOG PB 155, Aleksandrov 2021 TOT-like laparoscopic variant, Hill 2017 3-trocar technique, Conrad 2019 long-term laparoscopic PROs, Ye 2022 14-yr prospective FU, Veit-Rubin 2019 / Sohlberg-Elliott 2019 mesh-averse-renewal framing. Mechanism (**Cooper's-ligament anchor distinct from MMK pubic-symphysis-periosteum**), open + laparoscopic + TOT-like-modification techniques with intraoperative cystourethroscopy, outcomes table (CARE / SISTEr / Karmakar), complications (10% voiding dysfunction, 5–17% urgency, **3× higher posterior-compartment prolapse vs MUS at p=0.01**), evolving role with renewed mesh-averse interest. SUI database row + decision-framework + stepwise-ladder cross-links repointed. |
| **Autologous Fascial Pubovaginal Sling (PVS) (NEW dedicated page)** | [fca292d](https://github.com/nseranio/warwiki/commit/fca292d) | 31 DOI-linked refs at [autologous-pubovaginal-sling.mdx](docs/04-surgical-techniques/04f-incontinence-procedures/procedures/autologous-pubovaginal-sling.mdx). Anchored on **Wu 2021 *NEJM*** (67% AFS vs 74% MUS pooled), **Albo 2007 *NEJM* SISTEr** (66% AFS vs 49% Burch stress-specific at 24 mo), **AUA/SUFU 2023** (PVS **preferred** for ISD, failed MUS, mesh complications, irradiated tissue, violated urethra, mesh-averse), **Grigoryan 2024 meta** (no significant difference vs MUS; AFS RR 0.12 fewer long-term complications), **Osman 2018 "sling on a string"** (87.8% cure, **2% ISC, 8.2% urgency** with midurethral placement), Asfour 2022 / Shaw 2022 / Fayyad 2024 laparoscopic technique variants, **Cardenas-Trowers 2020 rectus-fascia safety zone** (5.4 cm above symphysis, ≤9.4 cm length; ilioinguinal/iliohypogastric nerve protection), **Buckley 2026** fascia-lata morbidity (32% any thigh issue at 6 wk → 17% at 12 mo, 8% cosmetic, no functional deficits), **Hong 2024 NSQIP** (n=41,533; fascia lata aOR 2.11 vs rectus, UTI-driven), Kim 2022 (53% UDI-6 success at 14.5 yr), Nair 2024 (67.2% satisfaction at 17 yr), Kuprasertkul 2019 E-SISTEr (85.2% reoperation-free at 15 yr), Offiah 2025 medium-term comparative (62% AFS vs 64% TVT, **lowest complication rate 22.6%**), Milose 2015 / Chen 2022 / McCoy 2016 salvage outcomes (**69.7% / 88.9% / 91%**), Mitsui 2007 PVR>100 / Qmax≤20 ISC predictors, Fulford 1999 urge-syndrome resolution (69%), and the **bladder-neck-closure continuum** (Willis 2015 / O'Connor 2005 / Kavanagh 2012; Kakizaki 1995 obstructing fascial sling for sphincter incompetence). SUI database row + 4 decision-framework / stepwise-ladder cross-links repointed from female-slings-suspensions to the new dedicated page. |
| **Vaginal Laser Therapy (NEW)** | [c1a1782](https://github.com/nseranio/warwiki/commit/c1a1782) | 35 DOI-linked refs at [vaginal-laser-therapy.mdx](docs/04-surgical-techniques/04f-incontinence-procedures/procedures/vaginal-laser-therapy.mdx). Cross-indication review covering GSM/VVA, SUI, lichen sclerosus, vaginal laxity, and BCS. Anchored on **Li 2021 *JAMA* sham-controlled RCT** (n=85: no significant difference between CO₂ and sham at 12 mo — substantial sham effect), **Cochrane 2025 Ippolito** (9 RCTs, modest improvement on ICIQ-UI SF below 5-point MID), **Lukanović 2026 meta** (10 sham-controlled RCTs ~850 women; pooled MD −1.08; **Er:YAG MD −1.42 strongest signal**), Jang 2022 / Nasr 2025 / Slongo 2025 laser-vs-estrogen-vs-RF equivalence, **Burkett 2021 RCT** clobetasol-vs-CO₂ for LS (laser superior on Skindex-29; 81% vs 41% satisfaction), **Zivanovic 2024 RCT** dual Nd:YAG/Er:YAG vs clobetasol for LS, Wei 2025 LS SR, Pereira 2024 vaginal-laxity meta (RCTs do not confirm benefit), Siliquini 2021 / Serquiz 2026 / Lőczi 2024 BCS data, Ahluwalia 2019 FDA MAUDE adverse-event analysis (45 reports / 33 chronic injuries), Mortensen 2022 99-study state-of-art review (n=51,094, no serious AEs in observational data), **FDA July 2018 safety communication**, **ACOG 2020 / 2021 BCS Consensus**, **AUA/SUFU 2023**, **ESSM 2020**, **EUGA 2023**, **Iglesia 2024** Expert Series, Li 2023 Er:YAG-vs-CO₂ direct comparison (Er:YAG superior on UDI-6 / IIQ-7 at 3 mo). Frames the **observational-vs-sham discrepancy** (75–100% reduction observational vs no benefit in Li 2021 *JAMA*) as the central tension. SUI database row updated with FDA-warning framing + slug; decision-framework laser mention cross-linked; GSM article gets a cross-link to the new page. |
| **Pelvic Floor Electrical Stimulation (PFES) (NEW)** | [7612de0](https://github.com/nseranio/warwiki/commit/7612de0) | 24 DOI-linked refs at [pelvic-floor-electrical-stimulation.mdx](docs/04-surgical-techniques/04f-incontinence-procedures/procedures/pelvic-floor-electrical-stimulation.mdx). Anchored on **Goode 2003 *JAMA* RCT** (adding PFES to comprehensive behavioral therapy did not increase effectiveness — 69-72% reduction in both clinic groups), **Cochrane 2017 Stewart** (56 trials, n=3,781 — ES probably better than no treatment for SUI; insufficient evidence vs PFMT), **Cochrane 2016 Stewart** (ES probably better than no treatment for OAB), **Lunardi 2025 meta** (ES not superior to PFMT), **Yu 2024 network meta** (PTNS most effective non-implanted modality SMD −1.86; IVES second SMD −0.97), **Xia 2021 meta** (PTNS as effective as antimuscarinics with significantly fewer AEs), **Tang 2025 / Zhao 2025 NMAs** (ES + biofeedback ranks highest for post-prostatectomy continence; SUCRA 89.9), **Mariotti 2009** (early PFES + BFT 96.7% continence at 6 mo), **Goode 2011 *JAMA*** (no benefit of adding PFES to behavioral therapy in persistent PPI > 1 yr), **Norton 2012 Cochrane** (biofeedback + ES 40% more likely to achieve full FI continence), **Mundet 2021** (ES + Kegel uniquely increases anal squeeze and resting pressure), **Lim 2017 sham-controlled MS RCT** (75% vs 21.7% response), **Lukanović 2025 sham-controlled MS RCT for UUI**, **Li 2026 SUI MS meta** (n=1,389), and the AUA / SUFU / ACOG / ACG / EAU position table. Mechanism split (motor-efferent for SUI vs afferent-pudendal for OAB), parameter table by indication (Hz / pulse width / duty cycle), modality table (IVES / intra-anal / surface / PTNS / TTNS / ExMS), home/wearable section (Innovo NMESWG, Leva IVSBS), and the "PFMT remains first-line" synthesis. Female SUI / male SUI / OAB-UUI database rows + male SUI ladder cross-link all repointed to the new dedicated page. |
| **Weight Loss for Urinary Incontinence (NEW shared page)** | [59f7073](https://github.com/nseranio/warwiki/commit/59f7073) | 21 DOI-linked refs at [weight-loss-incontinence.mdx](docs/04-surgical-techniques/04f-incontinence-procedures/procedures/weight-loss-incontinence.mdx). Single shared page serving both **female SUI and OAB / UUI** databases (the biology, dose-response, RCT, and bariatric data apply to both phenotypes; SUI-vs-UUI asymmetry called out explicitly). Anchored on **Subak 2009 PRIDE *NEJM* RCT** (n=338; ~8% behavioral weight loss → 47% UI episode reduction at 6 mo; SUI 58% vs UUI 42%; benefit attenuates at 18 mo with 5.5% maintenance), **Subak 2015 *JAMA Intern Med* LABS-2** (n=1,987; UI prevalence 49.3% → 18.3% in women after ~30% weight loss at 1 yr), Lee 2019 / Hadizadeh 2026 / Waeckel 2023 bariatric meta-analyses (UI 56% improvement; SUI 47% / UUI 53%; **FI unchanged**; sustained at 6 yr), **PRIDE cohort dose-response** (≥5% threshold; aOR 3.7 at 6 mo for ≥70% UI reduction; plateau >10% behavioral), AUGS Yazdany 2020 SR (15-18% SUI prevalence decrease), Imamura 2015 Cochrane, Look AHEAD (each 1 kg = 3% UI-odds reduction), ACOG PB 155 / 210, Wu 2021 *NEJM*, Lukacz 2017 *JAMA*, ICI-RS 2018 Marcelissen, Greer 2008 (obesity does not preclude anti-incontinence surgery — 81% obese vs 85% non-obese cure rate, NS), Markland 2011 / Güneş 2023 (limited and inconsistent FI benefit), Wilding 2021 STEP 1 semaglutide weight-loss benchmark, **Hammad 2025 TriNetX GLP-1 + BTX-A signal** (lower retention 4.9% vs 8.6%, lower UTI 8.8% vs 13.3% in non-diabetic OAB). Frames the SUI > UUI > FI gradient explicitly, the 5%-threshold / 10%-plateau dose-response, and bariatric vs behavioral magnitude. Female SUI + OAB-UUI database rows + female-SUI ladder cross-link + OAB-UUI ladder cross-link all repointed to the new shared page. |

### Editorial conventions reaffirmed this session

- **Pedicled-vs-free-graft framing** is essential for the inlay / onlay vocabulary in female urethroplasty. Inlay = graft placed *into* the urethrotomy with native-bed support; onlay = graft placed on the closed urethra with fascial-flap or quilting support. Vaginal pedicled flap (Blandy / Romero-Maroto) ≠ vaginal free graft (Borchert) ≠ buccal mucosa (Mukhtar/Greenwell, Berdondini, Jena).
- **Three-layer closure with perpendicular suture lines** is the cardinal principle for urethral diverticulectomy — overlapping suture lines drive fistula. Same vocabulary as the male VVF / urethroplasty literature.
- **Jefferson 2025 transurethral dorsal-inlay** is the **newest** female urethroplasty approach (2025) with a striking 0% complication / 0% SUI signal, tempered by single-center experience, 21 patients, and 12-mo follow-up. The 0%-SUI-vs-9–16%-dorsal-onlay differential is biologically explained by minimal urethral mobilization preserving periurethral support — useful framing for future technique adoption.
- **Bleed-through filtering for chatbot-augmented content** caught DCB / paclitaxel-rabbit / Optilume references in **multiple** fill articles. Always cross-check that every cited ref is actually used in body and renumber sequentially.
- **Honest framing for very-small-and-poor evidence** — the Female DCB section explicitly labels the 2-case-report + 1-12-pt-conference-abstract corpus as exactly what it is, with the practical caution that AUA 2023 recommends urethroplasty over repeat endoscopic management.
- **Citation-attribution discipline** — the user-supplied source for the lateral-based vaginal wall flap article cited "Barbagli 2019 Penile urethroplasty using Orandi's dorsal skin flap" which appears fabricated or misattributed; replaced with the actual Orandi 1968 *Br J Urol* paper.
- **Dedicated parallel pages** — when a database row links a female technique to a male page (e.g., "Female Ventral Onlay BMG" → male `ventral-onlay-omg`), create a parallel female-specific page rather than overloading the male article. Same pattern applied this session for Female Ventral Onlay Urethroplasty.

### Lint state

Build / lint not re-run this session given the volume of file additions; recommended next session.

---

## Previous handoff snapshot — May 1, 2026 (Posterior-urethroplasty + staged-urethroplasty + meatal-perineal expansions, Jordan vs Q-flap split, Palminteri double-face, BNR removal from urethral, exposure-approaches reference)

This session continued the urethroplasty-fill marathon and refined disambiguation across the urethral-reconstruction atlas. Branch: `claude/goofy-faraday-5a2aed`; pushes via `git push origin HEAD:main`. **Commit-and-push-after-every-change cadence preserved.**

### Arc 1 — Posterior urethroplasty pages (04a)

- **[Robotic Posterior Urethroplasty](docs/04-surgical-techniques/04a-urethral-reconstruction/posterior/robotic-posterior-urethroplasty.mdx)** — replaced stub with full deep-dive: AUA 2023 Conditional Grade C; etiology breakdown (Zhang 2023 n = 105: VUAS 48%, post-BPH 24%, radiation 24%); four surgical approaches (transabdominal, **combined robotic + open perineal ~ 39%**, robotic-assisted perineal Buckley, single-port Liu); reconstructive-technique distribution (EPA 30%, BNC resit 24.8%, Y-V 20%, BMG 13.3%); advantages (EBL 100 vs 200 mL p = 0.001; LOS 1–2 vs 3–4 d; Savun 2025 de-novo SUI 16.6% vs 100% p = 0.031); outcomes table (Zhang / Bearrick / Cavallo / Liu / Savun); **radiation-stratified outcomes** (Bearrick: post-BPH 100% vs radiation 60% p = 0.013); fixed two misattributed citations from the prior page; 8 DOI-linked refs. Two operative-technique videos added.
- **[Abdominoperineal (Transpubic) Urethroplasty](docs/04-surgical-techniques/04a-urethral-reconstruction/posterior/abdominoperineal-urethroplasty.mdx)** — new dedicated page (was a database stub-pointer to PFUI). Webster step-based classification (steps 1–4 + Combined), **Kizer 2007 supracrural-rerouting underperformance** (75% recurrence vs 80% abdominoperineal success), preoperative MRI / **pubourethral stump angle (PUA) predictor**, 7-step technique with **partial inferior pubectomy** (preferred over abandoned total pubectomy), **Koraitim "gold triad"**, outcomes (Koraitim 2005 98%, Pratap 2006 95%, Koraitim 2010 98.4%), low de-novo incontinence / impotence; 12 DOI-linked refs.

### Arc 2 — Staged urethroplasty (04a Section 5)

- **[Johanson Two-Stage Urethroplasty](docs/04-surgical-techniques/04a-urethral-reconstruction/staged-complex/johanson-two-stage.mdx)** — full deep-dive from stub. Stage 1 marsupialization step-by-step + 2–6 mo maturation interval (Palminteri 2022 < 12 mo failure predictor) + Stage 2 tubularization with dartos / spongiosal interposition. Outcomes: Furr 2021 BMG-only **96.4% vs STSG 53%** at 57 mo, Mangera SR 90.5% two-stage vs 75.7% one-stage penile, Warner 2015 long-segment 35.7% recurrence vs 17.5% one-stage BMG (selection-bias-noted), 17–19% Stage-1 revision required. 15 DOI-linked refs.
- **[Bracka Two-Stage Urethroplasty](docs/04-surgical-techniques/04a-urethral-reconstruction/staged-complex/bracka-two-stage.mdx)** — new page added under Section 5. Bracka 1995 origin (Cloutier 1962 conceptual root); Stage 1 graft-on-corpora (corpora bed) + ≥ 6 mo maturation + Stage 2 tubularization with **dartos / tunica vaginalis waterproofing**; **preputial-vs-BMG comparison** (Manasherova 2020 BMG 20% vs preputial 31% complications); hypospadias outcomes (Gill 100, Snodgrass 25 88% take / 5% fistula, Wani 2020 RCT vs Byars no significant differences); adult stricture (Palminteri 2002 92.8%, Furr 2021 BMG-only 96.4%); Bracka-vs-Johanson and Bracka-vs-Byars head-to-head tables; tunica vaginalis as alternative free graft (Rosito rabbit model); 17 DOI-linked refs.
- **Deleted** [kulkarni-two-stage.mdx](https://github.com/nseranio/warwiki/commit/0f86443) — same Johanson-pattern-with-BMG technique. Inbound links from male-urethroplasty Decision Framework, kulkarni-one-stage page, and female staged-bmg page repointed to the Johanson page; Vercel redirect added.

### Arc 3 — Meatal-perineal pages

- **[Meatotomy & Meatoplasty](docs/04-surgical-techniques/04a-urethral-reconstruction/meatal-perineal/meatotomy.mdx)** — title changed from "Meatotomy" to **"Meatotomy & Meatoplasty"**; full expansion. **Dothan 2023 meatotomy-vs-meatoplasty comparison table** (n = 2,211 children: meatoplasty 0% reoperation vs meatotomy 0.58%); existing 7-step ventral meatotomy preserved; new Meatoplasty Techniques section (standard ventral, **Y-V meatoplasty Sennert 2025 96.5% in 57 post-hypospadias-ring patients**, Jordan ventral preputial flap, extended Johanson, Malone V-relief for LS); **BMG meatoplasty options table** (Zumstein dorsal inlay 69%, Hoare sliding-T 92.4%, Sterling transurethral ventral 95%, Farrell transurethral dorsal 93.8%, Ehlers circumferential); Outcomes by Clinical Context (pediatric VanderBrink uroflow, post-hypospadias bimodal recurrence Bashi 2026, adult stepwise Meeks); LS section (Potts 2016 intraurethral steroids 89%, Kurtzman 2021 meta, Patel/Vanni PU 93%); Prevention (petroleum jelly per Morris meta); 27 DOI-linked refs.

### Arc 4 — Combined graft + flap consolidation (04a Section 4)

- **[Combined Dorsal BMG + Ventral Fasciocutaneous Flap (Erickson)](docs/04-surgical-techniques/04a-urethral-reconstruction/combined/erickson-dorsal-bmg-ventral-flap.mdx)** — full deep-dive expansion (concept / rationale, AUA 2023 Grade C, 5-step technique with Karapanos modification subsection, outcomes table Erickson / Kojovic / Karapanos / Anadani, **Warner 2015 32% vs 14% FC-flap-vs-graft-only complication signal** p = 0.02, GURS 2024 90% dual-BMG-preference signal); 12 DOI-linked refs. **Deleted** the redundant Karapanos Dorsal BMG + Ventral Orandi Flap article — folded into the Erickson page as a modification subsection. Vercel redirect added.
- **[Ventral BMG + Gracilis Muscle Flap (Vanni / Zinman)](docs/04-surgical-techniques/04a-urethral-reconstruction/combined/vanni-zinman-ventral-bmg-gracilis.mdx)** — new dedicated 04a page (was a foundations-anchor pointer). Rationale (gracilis as new vascularized graft bed when spongiosum compromised), indications (radiation 45–60%, prior failed urethroplasty 33–45%), 7-step technique with medial-circumflex-femoral pedicle entering 8–10 cm below the pubic tubercle, outcomes (Palmer 2015 80% / Rozanski 2020 76.7%, AUS 23–25%), Beckenstein 1996 urethral-epithelial-regeneration mechanism, donor-site morbidity (BMI > 25, smoking, prior radiation as flap-necrosis risk factors); 12 DOI-linked refs.

### Arc 5 — Free-graft additions and disambiguation

- **[Palminteri Double-Face (Two-Sided) BMG Urethroplasty](docs/04-surgical-techniques/04a-urethral-reconstruction/graft/palminteri-double-face.mdx)** — new page under Section 2 (Free Grafts). Dorsal Asopa-type inlay + ventral onlay BMG single-stage with spongiosal closure for tight / near-obliterative bulbar strictures; preserves the urethral plate, avoids transection. Outcomes Palminteri 2008/2011 88–90%, Schardein 2020 post-phalloplasty 75%, **0% post-op ED**. Frames the non-transecting advantage relative to **Redmond / Rourke 2020 AAU HR 4.8 recurrence signal**. Operative-technique video added; 13 DOI-linked refs. Decision Framework "Obliterative bulbar (no lumen)" entry now hyperlinks to the new page.
- **Quartey vs Q-flap split** — [Quartey Flap](docs/04-surgical-techniques/04a-urethral-reconstruction/flap/quartey-flap.mdx) (1983 transverse preputial / distal-penile island flap, 12–15 cm) and new [Q-Flap (Morey)](docs/04-surgical-techniques/04a-urethral-reconstruction/flap/q-flap.mdx) (Morey / Tran / Zinman 2000 modification: circumferential flap with **ventral midline extension** creating the "Q" outline, mean **17 cm range 15–24 cm** for panurethral strictures). Both pages carry reciprocal disambiguation `:::info` admonitions; database split into two distinct rows.

### Arc 6 — BNR removal from 04a, exposure-approaches reference, video adds

- **Removed Bladder Neck Reconstruction from urethral reconstruction.** Deleted male and female BNR stubs in 04a; removed two database rows (Section 6 male, F8 female); added Vercel redirects to canonical [04ab Bladder Neck Reconstruction](docs/04-surgical-techniques/04ab-bladder-neck-reconstruction/index.mdx) section. BNR / VUAS coverage now consolidated entirely in the 04ab section per the locked structure.
- **[Male Urethroplasty — Incisions & Approaches](docs/04-surgical-techniques/04a-urethral-reconstruction/male-urethroplasty-incisions-approaches.mdx)** — top-level 04a reference page (originally created as "Penile Urethroplasty — Approaches to Exposure" then renamed and broadened per user feedback). Now covers: **(1) perineal skin incisions** (midline vertical 1.9–3.1% SSI vs inverted-U 16.4–18.6% per Lin 2018, lambda incision Bascom 2016); **(2) three penile-stricture exposure approaches** (degloving / circumcising, Kulkarni penile invagination, midline ventral); **(3) anterior urethrotomy approaches** (ventral / Barbagli dorsal / Kulkarni dorsolateral / non-transecting); **(4) posterior approaches** (Webster steps + transpubic abdominoperineal + modified perineal Quartey 1988 + robotic transabdominal); **(5) graft / tissue placement** (dorsal onlay / ventral onlay / Asopa dorsal inlay / Kulkarni dorsolateral / Palminteri double-face / augmented anastomotic); **(6) flap-based decline** (Cotter 2019 86% drop / 280% dorsal-graft rise; GURS 2024 90% prefer dual BMG); **(7) one-stage vs staged** decision matrix. 23 DOI-linked refs. Vercel redirect from old `/penile-urethroplasty-approaches` slug. Cross-linked from Principles page (Principle 4) and male-urethroplasty Decision Framework header.
- **Operative-technique videos added** (`<VideoCards />`) to: [Robotic Posterior Urethroplasty](docs/04-surgical-techniques/04a-urethral-reconstruction/posterior/robotic-posterior-urethroplasty.mdx) (2 videos), [Palminteri Double-Face](docs/04-surgical-techniques/04a-urethral-reconstruction/graft/palminteri-double-face.mdx).

### Editorial conventions reaffirmed this session

- **Disambiguation admonitions** are the right tool when two related techniques share a conventional name. Used for Quartey vs Q-flap (`:::info` admonition with reciprocal cross-link from each page). The same pattern would apply if e.g. PMTP and propeller flap names get conflated again.
- **Citation-attribution discipline.** When pasted chatbot content has bracketed citation numbers that don't match the actual claims (e.g., a "systematic review" stat attributed to a 1975 case-series paper), reattribute conservatively to the most plausible source. Documented in the Johanson page (96.4%-BMG-only datum reattributed from Chapple 2014 to Furr 2021, 94%-salvage-Qmax from Alexander 1977 to Al-Ali 2001, 93.5%-satisfaction from Zimmerman 2010 to Minami 2025).
- **Citation correction in robotic posterior urethroplasty** — the prior page had two **fictional / misattributed references** ("Zhang J, Zhao C, Sun Z" and "Cavallo JA, Ballek N, Schaeffer EM"). Always verify author lists when expanding stub pages with chatbot-supplied content.
- **Database-row updates accompany every page move / split.** Single rows were split into two when techniques were disambiguated (Quartey + Q-flap; Meatotomy → Meatotomy & Meatoplasty), removed when pages were consolidated (Karapanos folded into Erickson; Kulkarni-two-stage into Johanson; BNR rows out of urethral), and added when new pages were created (Bracka, Palminteri double-face, Vanni / Zinman ventral BMG + gracilis, abdominoperineal urethroplasty, Q-flap, penile-urethroplasty-approaches).
- **Principles-page cross-links are the right home for cross-cutting references** — added the new "exposure approaches" cross-link in [Principles of Urethral Reconstruction](docs/04-surgical-techniques/04a-urethral-reconstruction/urethral-reconstruction-principles.mdx) Principle 4. Avoids cluttering the Decision Framework table while keeping discoverability.
- **Lint state**: build / scope / citations / links all clean (792 files post-deletions and additions); orphan-check signals remain known false-positives from JSX-array slug-detection.

---

## Previous handoff snapshot — late April 30 / early May 1, 2026 (Urethroplasty stub-fill marathon + perineal-urethrostomy expansions + Jordan flap consolidation + MANTA ureteroplasty + rectal mucosa graft)

This session was a sustained content-fill pass focused on **04a Urethral Reconstruction** with parallel additions to **04d Upper Tract** and **foundations Grafts**. Branch: `claude/goofy-faraday-5a2aed`; pushes via `git push origin HEAD:main`. **Commit-and-push-after-every-change cadence preserved** (15+ commits this session).

### Arc 1 — Urethroplasty technique-page stub-fill marathon

Filled or significantly expanded the following technique pages from stub to full deep-dive (each a self-contained article; redundant concept-level material cross-linked rather than duplicated):

- **[Preputial Spiral Graft Urethroplasty (PSGU)](docs/04-surgical-techniques/04a-urethral-reconstruction/graft/preputial-spiral-graft.mdx)** — Kulkarni 2023 origin, helicoidal-harvest concept, 6-step technique, indications (panurethral &gt; 10 cm), contraindications (LS, circumcision), Bandini 2025 multicenter outcomes table (n = 114, 9.6% recurrence at 16 mo, Qmax 4.5 → 24 mL/s), AUA-2023-vs-PSGU comparison anchored on Alrefaey 2025 RCT (penile skin vs BMG 93.2% vs 97.9%) + Berg 2024 GURS 90% BMG-preference signal. **8 DOI-linked refs.**
- **[Endoscopic Urethroplasty](docs/04-surgical-techniques/04a-urethral-reconstruction/minimally-invasive/endoscopic-urethroplasty.mdx)** — fully transurethral BMG urethroplasty for posterior strictures. Two named techniques: **Warner technique** (Ungerer 2023, n = 1, RD 180 suturing-device pulley delivery for membranous urethral stricture) and **Doležel endourethroplasty** (2024, n = 11, 23-yr institutional experience, **73% 3-yr SRFS rising to 81% with permitted auxiliary cold-knife DVIU as protocol element**, low de-novo-incontinence rate). Head-to-head Warner-vs-Doležel table; open-perineal-D-BMGU benchmarks (Angulo 2021, Sterling 2024). **5 refs.**
- **[ICG-Guided Flap / Graft Perfusion Assessment](docs/04-surgical-techniques/04a-urethral-reconstruction/minimally-invasive/icg-perfusion-assessment.mdx)** — six application categories: dorsal-onlay BMG graft-bed (Zhang 2024 ≥ 60%), Blandy flap PU (Zhang ≥ 40%), staged urethroplasty after failed hypospadias, Paraboschi 2023 onlay preputial-island flap, **Wang 2026 TIP cohort** (the strongest fistula signal: 0% well-perfused vs 75% poorly-perfused), **Hebert 2024 ureteral parallel** (63% decision-change, 1.8% stricture). Pharmacology / FDA-label / iodine-allergy detail explicitly cross-linked to [foundations ICG](docs/01-foundations/pharmacology/intraoperative-adjuncts/visualization-agents/icg.mdx) rather than duplicated. **7 refs.**
- **[Meatotomy](docs/04-surgical-techniques/04a-urethral-reconstruction/meatal-perineal/meatotomy.mdx)** — etiology (Morris 2017 meta 0.66% post-circumcision, Homer 2014 LS 1-in-5, Nabavizadeh 2020 atopic 61% vs 13%), AUA 2023 indications, 7-step ventral-meatotomy technique table, **extended Johanson maneuver** (Morey 2007, 87%), **Malone LS technique** (2004, 100% no recurrence), outcomes table (Meeks / Morey / Dothan / Malone), complications (LS recurrence 20.5% vs 7.5%, p = 0.04), escalation pathway to sliding-T (Hoare 2021) and transmeatal OMG (Farrell 2022). **15 refs.**
- **[7-Flap Perineal Urethrostomy](docs/04-surgical-techniques/04a-urethral-reconstruction/meatal-perineal/seven-flap-perineal-urethrostomy.mdx)** — corrected the prior misnomer ("multiple local perineal skin flaps in a seven-flap pattern" → **single laterally based flap shaped like the number "7"**). Full algorithmic-midline-approach (loop-vs-7-flap intraoperative decision driven by urethra-to-skin distance and BMI: 30 vs 34.9 kg/m² in McKibben 2019). 18-step technique. Outcomes from French 2011 / McKibben 2019 / Joshi 2024 / Fuchs 2018 / Klemm 2024. Lin 2018 midline-vs-inverted-U SSI evidence (1.9–3.1% vs 16.4–18.6%). PU-vs-long-stricture-anterior-urethroplasty TURNS data (14.5% vs 30.2% 2-yr failure). Then expanded again (see Arc 2 below) with **BMG-augmented PU section, full stenosis-salvage ladder, Hughes 2020 post-radiation histopathology**, and **LS-specific evidence**. **18 refs total after expansion.**
- **[Blandy Perineal Urethrostomy](docs/04-surgical-techniques/04a-urethral-reconstruction/meatal-perineal/blandy-perineal-urethrostomy.mdx)** — corrected concept (inverted U-shaped **single posteriorly based flap** advanced to opened / marsupialized urethra; distinct from Johanson and from 7-flap-with-transected-urethra). 5-step technique; **Lin 2018 anatomic cost of inverted U** (1.6–2.0× more vessels / nerves cadaverically; SSI 16.4–18.6% vs 1.9–3.1% midline; longer LOS). Outcomes Ponce de León 2023 / Lumen 2015 / Myers 2011 / Joshi 2024 / Fuchs 2018 with the **era-improvement signal (51% → 75% in last 8 yr)**. Prognostic factors (age, BMI, era, SPC). "Why supplanted" framing with explicit caveat that 75% modern-era success keeps it valid. **12 refs.**
- **[Jordan Fasciocutaneous Ventral Penile / Preputial Island Flap](docs/04-surgical-techniques/04a-urethral-reconstruction/flap/fasciocutaneous-penile-flap.mdx)** — see Arc 4 (consolidation).

### Arc 2 — BMG-Augmented PU + stenosis-salvage ladder (DeLong / Jordan)

Per user request — *"Mostly want the BMG augmented PU to live somewhere in WARWIKI"* — added a comprehensive section to the 7-flap PU page:

- **Concept and rationale** — standard PU 5–22% stomal-stenosis problem; LS-resistant epithelial surface as the main BMG advantage.
- **Indications** — pananterior, LS (23% of DeLong cohort), failed prior hypospadias ("hypospadias cripples"), multiple failed urethroplasties, Fournier's, urethral / penile cancer, comorbid patients, patient preference.
- **7-step technique table** — DeLong / McCammon / Virasoro: lithotomy + midline incision → urethral mobilization → dorsal urethrotomy preserving plate → BMG harvest → quilted dorsal onlay → ventral skin maturation → 2–3 wk catheter.
- **Outcomes-by-case-mix interpretation** — frames the DeLong 80% vs Joshi / Fuchs 95% gap as case-mix-driven, not technique inferiority.
- **When BMG augmentation adds value vs is unnecessary** — selection rule centered on dorsal-plate compromise.
- **LS-specific evidence** — **Patel / Vanni 2016** (PU 93% vs single-stage BMG 75% in LS) and **Kurtzman 2021 meta** (10% pooled BMG-LS recurrence rising to 18% with ≥ 24 mo FU).
- **Stenosis-salvage ladder** (5 steps): single dilation (Myers 83% → 93%) → redo PU with 7-flap (French / Shinchi salvage) → **Kamat 2008 BMG composite stomal repair** (especially for LS-affected stoma) → posterior thigh propeller flap revision (Schulster 2021) → penile-skin-graft composite stoma (Shinchi).
- **Hughes 2020 post-radiation urethral histopathology** added as the mechanistic explanation for the OR 11.2 stenosis signal in irradiated patients (decreased vascularity p = 0.0005, increased collagen density / hyalinized fibrosis).

### Arc 3 — Upper Tract: MANTA ureteroplasty + Rectal mucosa graft (foundations) cross-linked with enterourethroplasty

- **[MANTA Ureteroplasty](docs/04-surgical-techniques/04d-upper-tract-reconstruction/interposition-graft/manta-ureteroplasty.mdx)** — new page based on **Kam 2024** (*Urol Video J*, n = 1, Guy's Hospital): non-transecting muco-mucosal posterior-plate anastomosis between healthy proximal ureter and bladder, augmented with ventral BMG onlay over a DJ stent. Adapted from the bulbar-urethral [MANTA urethroplasty](docs/04-surgical-techniques/04a-urethral-reconstruction/anastomotic/manta.mdx) (Marks 2023) and [MsANTA](docs/04-surgical-techniques/04a-urethral-reconstruction/anastomotic/joshi-step-msanta.mdx) (Joshi 2022). Salvage option for revision distal ureteral strictures extending into a prior bladder anastomosis when reimplant length is inadequate, the bladder is too small for a long Boari, and bowel interposition is undesirable. Database row added in the upper-tract index "Graft / Onlay Reconstruction" domain.
- **Rectal Mucosa Graft section** added to [Grafts in GU Reconstruction](docs/01-foundations/surgical-principles/grafts-gu-reconstruction.mdx) — Quick Reference table row (between Labial mucosa and Intestinal segment), full Graft Detail subsection (Thyrmos 1902 historical origin; modern transanal harvest evolution; harvest-technique table comparing TEM / R-TAMIS / single-port endorobotic; configurations dorsal / ventral / staged; outcomes table Granieri 2019 TURNS 85% / Howard 2019 R-TAMIS 100% graft take / Palmer 2016 TEM 75%; BMG advantages with the columnar-vs-squamous epithelium caveat). Cross-linked bidirectionally with [Enterourethroplasty](docs/04-surgical-techniques/04a-urethral-reconstruction/graft/enterourethroplasty.mdx) (which already covered the named-operation deep-dive). 7 new refs added to grafts overview.

### Arc 4 — Page consolidations and focused-scope rewrites

Per user instruction *"minimize redundancy"*, several urethral-reconstruction pages were rebuilt as **focused urethroplasty-specific applications** with explicit cross-links to the foundations concept-level page rather than duplicated content:

- **[Propeller Flap Urethroplasty](docs/04-surgical-techniques/04a-urethral-reconstruction/flap/propeller-flap.mdx)** — rebuilt as a tight Schulster 2021 PU-revision page. Concept-level material (Tokyo Consensus, perforator anatomy across IPAP / SCIP / vPMT / EPAP, broader complications, venous-congestion mitigation) lives only in [foundations propeller flap](docs/01-foundations/surgical-principles/flaps/propeller-flap.mdx). Database eponym corrected from "Teo TC, 2010" (concept paper) to "Schulster, 2021" (urethroplasty application).
- **[Singapore Flap Urethroplasty](docs/04-surgical-techniques/04a-urethral-reconstruction/flap/singapore-flap.mdx)** — rebuilt as urethroplasty-specific (Tzarnas 1994 first GAS use; Monstrey 2001 2 patients posterior-urethral defects in scarred perineum; Wu 2022 phalloplasty PTF cohort with 38.5% urethral complication rate, lowest of 4 neourethra options). Concept-level (nomenclature, vascular anatomy, vulvovaginal / RVF / vulvar-oncologic / pediatric / Fournier's / burn-contracture applications) cross-linked to [foundations Singapore / Pudendal Thigh Flap](docs/01-foundations/surgical-principles/flaps/singapore-pudendal-thigh.mdx).
- **[Jordan Fasciocutaneous Ventral Penile / Preputial Island Flap](docs/04-surgical-techniques/04a-urethral-reconstruction/flap/fasciocutaneous-penile-flap.mdx)** — **consolidated** the previously separate `fasciocutaneous-penile-flap.mdx` (Jordan & Schlossberg 1987) and `penile-skin-flap-fossa.mdx` (Jordan GH 1999) stubs into a single article. Both stubs described the same flap family applied to the same anatomic problem. The single page is anchored on Jordan 1987 origin (J Urol), 6-step technique, indications, **LS / BXO contraindication** with the defining **Virasoro / Eltahawy / Jordan 2007 long-term divergence** (100% non-LS at 10.2 yr vs 50% LS recurrence), Morey 2007 ≤ 2.5 cm (91%) vs &gt; 2.5 cm (54%) signal, and the Armenakas / McAninch decision rule (healthy skin → flap; inflamed / scarred → BMG). Vercel redirect added; Section 7 database row consolidated.
- **Deletions** (no inbound links): [dorsal-circumcision-approach.mdx](https://github.com/nseranio/warwiki/commit/b1a1faf) (not a distinct named technique), [penile-inversion.mdx](https://github.com/nseranio/warwiki/commit/dc90e0b) (the urethral-reconstruction file; the GAS feminizing-procedures penile-inversion vaginoplasty is unaffected — different concept).

### Arc 5 — Video embeds across the urethroplasty atlas

YouTube operative-technique videos added via `<VideoCards />` to:

| Page | Videos |
|---|---|
| [Excision and Primary Anastomosis](docs/04-surgical-techniques/04a-urethral-reconstruction/anastomotic/excision-primary-anastomosis.mdx) | 3 |
| [Jordan Vessel-Sparing EPA](docs/04-surgical-techniques/04a-urethral-reconstruction/anastomotic/jordan-vessel-sparing-epa.mdx) | 1 |
| [Augmented Anastomotic](docs/04-surgical-techniques/04a-urethral-reconstruction/anastomotic/augmented-anastomotic.mdx) | 1 |
| [ANTA](docs/04-surgical-techniques/04a-urethral-reconstruction/anastomotic/anta.mdx) | 1 |
| [Ventral Onlay BMG](docs/04-surgical-techniques/04a-urethral-reconstruction/graft/ventral-onlay-omg.mdx) | +2 (now 3 total) |
| [Dorsal Onlay BMG](docs/04-surgical-techniques/04a-urethral-reconstruction/graft/dorsal-onlay-omg.mdx) | +1 (now 3 total) |
| [PSGU](docs/04-surgical-techniques/04a-urethral-reconstruction/graft/preputial-spiral-graft.mdx) | 1 |
| [Pedicled Preputial Tube](docs/04-surgical-techniques/04a-urethral-reconstruction/flap/pedicled-prepucial-tube.mdx) | 1 |
| [Transmeatal OMG Ventral Inlay](docs/04-surgical-techniques/04a-urethral-reconstruction/minimally-invasive/transmeatal-omg-ventral-inlay.mdx) | 2 |
| [Drug-Coated Balloon (canonical)](docs/04-surgical-techniques/drug-coated-balloon.mdx) | 2 |
| [Drug-Coated Balloon Therapy / Optilume (pharmacology)](docs/01-foundations/pharmacology/dermatologic-topical-urethral/drug-coated-balloon-therapy.mdx) | 2 |
| [DVIU and Urethral Dilation](docs/04-surgical-techniques/04a-urethral-reconstruction/minimally-invasive/dviu.mdx) | 1 |
| [Enterourethroplasty](docs/04-surgical-techniques/04a-urethral-reconstruction/graft/enterourethroplasty.mdx) | 1 |

### Editorial conventions reaffirmed this session

- **Page-scope discipline**: when an existing foundations page already covers concept-level content (vascular anatomy, broad complications, technique principles, multi-domain applications), the urethral-reconstruction technique page **must not duplicate** it. Open with an explicit cross-link paragraph that names what lives where, then focus the technique page tightly on the urethroplasty application. Applied to propeller flap, Singapore flap, ICG perfusion assessment.
- **Database-row eponym discipline**: when a "concept paper" author and a "urethroplasty application" author are different (e.g., propeller flap — Teo 2010 concept vs Schulster 2021 urethroplasty application), the database row should credit the **urethroplasty application** author, not the concept-paper author. Same for Jordan 1987 vs the ambiguously-dated 1999 stub.
- **Stub consolidation**: when two stubs describe the same flap family applied to the same anatomic problem with the same author lineage (Jordan & Schlossberg 1987 + Jordan 1999, both ventral penile / preputial fasciocutaneous flap for fossa navicularis), they should be merged into a single deep-dive page with a Vercel redirect from the deleted slug, and the database collapsed to a single row.
- **Editorial cleanup of pasted chatbot-source content** (now standard checklist applied 10+ times this session): strip trailing "Would you like to explore..." prompts; strip "Figure N / undefined" placeholder blocks; strip unrelated textbook figure captions (e.g., the three Blandy-Urology-3rd-Edition figures pasted with the meatotomy source — covering chordee correction, post-traumatic urethral repair, and dartos-pedicled patches — none belonged on the meatotomy page); rebuild mashed comparison tables (no whitespace between cells) into proper markdown; reconstruct swallowed `<` artifacts (`p [N]` → `p &lt; 0.001`, `&lt; 2.5 cm`, etc.); convert `[N]` bracket citations to `<sup>[[N]](#refN)</sup>`; add DOI / PubMed links to every reference; filter bleed-through references (refs from unrelated articles); drop CPT-coding sections from clinical reference pages (lives in [billing-coding](docs/08-resources/hidden-curriculum/billing-coding.mdx) instead).
- **Cross-link bidirectionally for shared topics**: when a graft material (rectal mucosa) and a named operation (enterourethroplasty) overlap, both pages should cross-link to each other so readers entering from either direction reach the full picture. Same pattern applied to MANTA ureteroplasty ↔ MANTA urethroplasty, propeller-flap urethroplasty ↔ foundations propeller flap, Singapore flap urethroplasty ↔ foundations Singapore / pudendal thigh.
- **Lint state**: build / scope / citations / links all clean (791 files post-deletions); the 90 orphan-check signals remain known false-positives from the JSX-array slug-detection limitation in `scripts/check-orphans.js`.

---

## Previous handoff snapshot — April 30, 2026 (Citation-format normalization complete + pre-launch fixes)
