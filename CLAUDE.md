...
- New per-device page **[g-spot-amplification.mdx](docs/04-surgical-techniques/04l-cosmetic-genital-surgery/g-spot-amplification.mdx)** (11 refs). Anchored on **Puppo & Gruenwald 2012** anatomic-existence-debate review (the central caveat — the G-spot may not exist as a discrete structure); ACOG 2020 + FIGO 2025 not-medically-indicated framing; **Clarke 2026 *Obstet Gynecol*** anterior-vaginal-wall PRP-vs-saline RCT n=52 (the closest available proxy — 69.2% vs 34.6% improvement at 6 mo, p=0.01; individual FSFI subscales did not reach significance); adjacent vaginal-augmentation literature (Yi 2026 / Lai 2023 MAFT / Menkes 2021 / Bensmail 2025 HA-for-VVA / CIVIT Leylek 2025). Explicit cosmetic-vs-therapeutic counseling distinction at the bottom (**G-shot ≠ HA-for-GSM**). The G-Spot Amplification database row was repointed from null slug to the new canonical page; only one slug-less placeholder remains in the female-cosmetic database (Microfat + Nanofat Grafting — content captured in [labia-majora-augmentation](docs/04-surgical-techniques/04l-cosmetic-genital-surgery/labia-majora-augmentation.mdx) and [fat-grafting-mons](docs/04-surgical-techniques/04l-cosmetic-genital-surgery/fat-grafting-mons.mdx)).
