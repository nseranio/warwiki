...
**Bench (remaining, lower-value):** pelvic-floor levator-ani-from-below anatomy; Mathieu flip-flap or onlay-island-flap (the hypospadias page already carries 2 figures — weigh over-imaging before adding). The flagship reconstructive techniques across urethral / upper-tract / bladder / incontinence / prolapse / prosthetics / diversion / fistula are now all illustrated; the SUI surgical trio (MUS · autologous PVS · Burch) is complete. Detail in `CHANGELOG.md` under 2026-06-07.
