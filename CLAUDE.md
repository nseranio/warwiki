...
- **[Penile Urethroplasty — Approaches to Exposure](docs/04-surgical-techniques/04a-urethral-reconstruction/penile-urethroplasty-approaches.mdx)** — new top-level 04a reference page covering the three surgical-access approaches: **degloving / circumcising incision**, **Kulkarni penile invagination** (perineal-only, no penile incision), **midline ventral penile incision**. Comparison table; **Cotter 2019 contemporary-trends signal** (~ 86% fasciocutaneous-flap-use decline, ~ 280% dorsal-graft increase over 7 years); Quick Selection Guide. Cross-linked from the Principles page (Principle 4) and male-urethroplasty Decision Framework header. 13 DOI-linked refs.
