...
## Current Handoff - 2026-05-23 — Platform infra wave (CI / tests / CONTRIBUTING / scripts) + quiz + decision tree + responsive table + freshness + bowel-anastomosis expansion + stoma-site-marking
