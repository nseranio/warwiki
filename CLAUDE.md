...
`npm run lint:links` clean across 808–810 files at each commit point. Citation lint clean for all new and rebuilt pages this session. Build not re-run end-to-end given file-creation volume; recommended next session.
